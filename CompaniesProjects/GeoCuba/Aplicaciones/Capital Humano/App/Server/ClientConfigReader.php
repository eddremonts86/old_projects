...
final class ClientConfigReader
{
	...
	public function GetAppIcon()
	{
		...
		if($this->_config_store['icon'])
		{
			...
			return "<link rel='shortcut icon' type='image/png' href='Subsystems/$_subsys/Config/Client/$_icon.png'/>";
		}
		return '';
	}

    public function GetAppGeneralIcon()
	{
		return "<link rel='shortcut icon' type='image/png' href='App/Client/img/icons/win.png'/>";
	}
