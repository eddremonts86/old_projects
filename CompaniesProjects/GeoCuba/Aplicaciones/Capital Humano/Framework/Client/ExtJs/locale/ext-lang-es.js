...
Ext.onReady(function() {
    ...
    if (exists('Ext.form.field.VTypes')) {
        Ext.apply(Ext.form.field.VTypes, {
            emailText: 'Este campo debe ser una dirección de correo electr&oacute;nico con el formato "edd@dominio.com"',
...
Ext.define("Ext.locale.es.form.CheckboxGroup", {
    ...
    blankText: "Debe seleccionar al menos un &ioacute;tem de este grupo"
});
