function CursosGestionar()
{
    ...
    this.Render = function(Panel){
        ...
        this._btn_imp = Ext.create('Ext.Button', {
            text: 'Imprimir',
            id: 'imp_Cursos_btn_id',
            tooltip : 'Imprimir el Listado de Eventos',
            iconCls: 'print',
            handler: function(){
                App.PrintModel(Ext.getCmp('Cursos_grid_id').store, 'Eventos en Oferta');
            },
            scope:this
        });
                    ...
                    Ext.create('Ext.window.Window', {
                        ...
                        html:
                            '<ul class="nav nav-list">' +
                                '<li>El apartado <span class="label label-info">" Cursos o Eventos  Inactivos"</span>' +
                                ' le permite reactivar un curso que este inactivo actualmente. </li>' +
                                '<span class="label label-warning">Nota:</span><br>' +
                                'Antes de activar nuevamente el curso debe saber la fecha de inicio y la final de la nueva edición.' +
                                '</li>' +
                                '</ul>'
