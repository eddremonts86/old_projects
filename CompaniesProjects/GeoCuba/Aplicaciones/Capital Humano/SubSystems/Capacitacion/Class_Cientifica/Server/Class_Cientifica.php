...
class Class_Cientifica extends Module {
    ...
    public function ValidateEliminar(&$params) {
        ...
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "El Class_Cientifica a eliminar esta siendo usado por Contrato.");
            return false;
        }
        return true;
    }
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.categoria_cientifica");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Nombre del Class_Cientifica incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.categoria_cientifica');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "La Clasificación Cientifica: '$nombre' ya existe.");
            return false;
        }return true;
       }
