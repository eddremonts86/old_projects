                        ...
                        Ext.create('Ext.window.Window', {
                            ...
                            html:
                                '<ul class="nav nav-list">' +
                                    ...
                                    '<br>No es necesario ir uniendo un curso y un trabajador sino que puede  dar un rango de usuarios y asignarle un rango de cursos a los mismos.<br>' +
                                    '</li>' +
                                    '</ul>'
