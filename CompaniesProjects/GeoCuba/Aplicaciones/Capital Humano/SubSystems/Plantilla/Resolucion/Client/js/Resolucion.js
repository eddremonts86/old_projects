function Resolucion(){
    ...
    this.Init = function()
    {
        ...
        App.InsertMenuItem('Plantilla', _menu_item_config_resolucion);
    ...
    this.BuildMainPanel = function(filterObj)
    {
        ...
        this.__data_store = App.BuildJsonStore('Resolucion.Resolucion.CargarDatos',
            {
                fields: [
                    {name: 'id'},
                    {name: 'nombre'},
        ...
        var _grid = new Ext.grid.Panel(
            {
                ...
                enableLocking: true,
                 columns: [{text: "Resoluciones", flex: 1, dataIndex: 'nombre'}],
                plugins: [{
                 ptype: 'rowexpander',
                 ...
                 '<b>Nota:</b>Para descargar la Resolución,Doble Click</p>'
                 )
                 }],
                        ...
                        Ext.create('Ext.window.Window', {
                            ...
                            html:
                                '<ul class="nav nav-list">' +
                                    ...
                                    ' le permite gestionar las resoluciones,decretos o normativas referente a todas las operaciones que se realizan en la empresa.<br>  ' +
                ...
                listeners: {
                     selectionchange: {
                        fn: function(View, selections, options) {
                            if(selections.length == 0){this.Disable('Resolucion');}
                            else{this.Enable('Resolucion');}
                            },
                            scope: this
                            },
                    itemclick:{
                        fn:function(){
                           ...
                           this.cadena = this.dir + this.nombre;
                            Ext.getCmp('panel_file').update('<embed src="SubSystems/Plantilla/Resolucion/Server/pdf.php?cadena='+this.cadena+'" type="'+_selected_rcd.data.extension+'" width="100%" height="100%"> </embed>');
                    ...
                    itemdblclick:{
                        fn: function(){
                           ...
                           this.nombre= _selected_rcd.data.nombre_file;
                           this.cadena = this.dir + this.nombre;
                           window.open('SubSystems/Plantilla/Resolucion/Server/pdf.php?cadena='+this.cadena+'&decode=s','','menubar=yes');
                        },
                        scope: this
                    }
                }
