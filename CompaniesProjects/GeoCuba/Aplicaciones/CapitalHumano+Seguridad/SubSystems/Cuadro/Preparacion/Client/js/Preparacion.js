    ...
    this.BuildMainPanel = function(filterObj)
    {
        ...
        var _grid = new Ext.grid.Panel({
            ...
            columns: [
                ...
                {header: 'Preparacion',menuDisabled: true,sortable : false,dataIndex: 'nombre',flex: 5},
                {
                    xtype:'actioncolumn',
                    width:100,
                    header: 'Ver Cuadros',
                        ...
                        handler: function(grid, rowIndex, colIndex) {
                            ...
                            Ext.create('Ext.window.Window',{
                                ...
                                items: {
                                    xtype: 'grid',
                                    border: false,
                                    columns: [{header: 'nombre_completo',menuDisabled: true,sortable : false,dataIndex: 'nombre_completo',flex: 1}],
