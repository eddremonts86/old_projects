...
class Tviolacion extends Module {
    ...
    public function ValidateEliminar(&$params) {
        ...
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "El Sexo a eliminar esta siendo usado por Trabajador.");
            return false;
        }
        return true;
    }
    ...
    public function ValidateAdd(&$params){
       // print_r($params);
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El Tviolacion '$nombre' ya existe.");
            return false;
        }return true;
       }
    ...
    public function ValidateModid(&$params){
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El Sexo '$nombre' ya existe.");
            return false;
        }
