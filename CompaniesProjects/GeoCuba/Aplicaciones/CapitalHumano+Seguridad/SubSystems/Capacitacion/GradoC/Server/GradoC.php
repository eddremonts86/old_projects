...
class GradoC extends Module {
    ...
    public function ValidateEliminar(&$params) {
        ...
        $count = $datos->Contains(array('grado_cientifico_id' => "'$id'"));
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "El GradoC a eliminar esta siendo usado por Contrato.");
            return false;
        }
        return true;
    }
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.grado_cientifico");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Nombre del GradoC incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.grado_cientifico');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El GradoC '$nombre' ya existe.");
            return false;
        }return true;
       }
