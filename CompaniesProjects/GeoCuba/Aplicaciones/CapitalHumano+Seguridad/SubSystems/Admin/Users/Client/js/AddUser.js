...
AdminUsers.prototype.AddUser = function()
{
	...
	if(_form.isValid())
	{
		App.ShowMsgBox(Ext.Msg.wait('Por favor, espere un momento','Procesando...'));
          ...
          if(result)
          {
              App.InfoMessage('Información', 'Se adiciono el usuario satisfactoriamente');
               _form.reset();
        ...
        App.InfoMessage('Información', 'Debe llenar todos los campos,recuerde que debe coincidir la contraceña y la confirmación ');
