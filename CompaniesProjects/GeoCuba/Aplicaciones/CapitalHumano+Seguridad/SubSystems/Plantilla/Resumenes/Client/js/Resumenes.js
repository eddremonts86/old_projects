        ...
        var panel_tree = Ext.create('Ext.form.Panel', {
                        ...
                        Ext.create('Ext.window.Window', {
                            ...
                            html:
                                '<ul class="nav nav-list">' +
                                    '<li>El m&oacute;dulo <span class="label label-info">" Todos los Reportes"</span>' +
                                    ...
                                    'Anailizar la plantilla permite conocer el completamiento de la misma ,la situaci&oacute;n de la fuerza laboral en base a su ocupaci&oacute;n y contrato. <br>' +

                                    '<span class="label label-success">Estructura de plantilla :</span><br>' +
                                    'Divide la plantilla por cargos en unidades y &aacute;reas adem&aacute;s de conocer las plasas ocupadas y vacantes de la empresa.<br>' +
                                    ...
                                    '¿Fluctua la plantilla de la empresa ? ¿Cuantos trabajadores han solicitado la baja o licencia? ' +
                                    '¿Qui&eacute;nes son? En este apartado lo podr&aacute;s saber.<br>' +
                                    ...
                                    'Listado de los trabajadores seg&uacute;n su integraci&oacute;n pol&iacute;tica y nivel cultural<br>' +
                                    ...
                                    'Es necesario saber la antiguedad de los trabajadores en la empresa para poder dar un trato justo y a la vez diferenciado con la plantilla aqu&iacute; podr&aacute; conocerlo<br>' +
                                    ...
                                    'Conosca la dispocici&oacute;n de la empresa en cuanto a sexo, edad , color de piel, lugar de procedencia, etc' +
           ...
           // collapseMode:'mini',
            ...
            html: '<div class="accordion" id="accordion2">' +
                ...
                '       <div class="accordion-inner" onclick="Sit_fursa_laboral()"><a> ' + 'Situaci&oacute;n de la Fuerza Laboral </a></div>' +
                '       <div class="accordion-inner" onclick="plantilla_p4()"><a> ' + 'Situaci&oacute;n de la Fuerza Laboral-P4 </a></div>' +
                ...
                '  <div class="accordion-inner" onclick="Fluctuacion()"><a> ' + 'Fluctuaci&oacute;n de plantilla</a></div>' +
    ...
    this.grafica = Ext.create('Ext.Button', {
        ...
        listeners: {
            ...
            click: function () {
                ...
                Ext.create('Ext.window.Window', {
                    title: 'Gr&aacute;ficos de la Aplicaci&oacute;n',
                    height: 550,
                    width: 800,
                    layout: 'fit',
                    items:[chart]
...
function Sit_fursa_laboral() {
   ...
   panel.setTitle('Todos los Reportes - <span class="label label-info">Situaci&oacute;n de la fuerza laboral</span>');
    grid.reconfigure(this.__data_store1, [
        ...
        {
            text: 'Categor&iacute;a Ocupacional',
            columns: [
...
function plantilla_p4() {
    ...
    grid.reconfigure(this.__data_store1, [
        ...
        {
            width: 160,
            text: 'Categor&iacute;a <br>Ocupacional',
            dataIndex: 'catocup'

        } ,
        {
            width: 160,
            text: 'Clasificaci&oacute;n<br/>Directo/Indirecto',
            dataIndex: 'di'
...
function completamientoplantilla_x_categorias_ocupacionales(){
    ...
    this.__data_store.load({params: {start: 0, limit: 25}});
   panel.setTitle('Todos los Reportes - <span class="label label-info">Trabajadores contratados por categor&iacute;a</span>');
    grid.reconfigure(this.__data_store, [
        {
...
function CargosPlantilla_cargo_area() {
   ...
   panel.setTitle('Todos los Reportes - <span class="label label-info">Plantilla de cargos por &aacute;rea</span>');
    grid.reconfigure(this.__data_store, [
        ...
        {
            text: 'Preparaci&oacute;n',
            // locked:true,
            dataIndex: 'preparacion',
            flex: 2
        },
        {
            text: 'Categori&iacute;a',
            dataIndex: 'categoria',
            tdCls: 'task',
            flex: 2
        },
...
function Fluctuacion() {
   ...
   panel.setTitle('Todos los Reportes - <span class="label label-info">Fluctuaci&oacute;n</span>');
    ...
    this.graficar=Ext.create('Ext.button.Split',{
                    ...
                    cls:'btn btn-group',
                    menu:[
                        {text : 'Tipo de Gr&aacute;ficos 1'},
                        {text : 'Tipo de Gr&aacute;ficos 2'},
                        {text : 'Tipo de Gr&aacute;ficos 3'}
                        ]
                });
    this.imprime = Ext.create('Ext.Button', {
        xtype: 'button',
...
function trabajadores_antiguredad_share(){
    ...
    this.panel = Ext.create('Ext.form.Panel', {
        ...
        items: [
            ...
            {
                allowBlank: false,
                fieldLabel: 'Años de antig&uuml;edad a reportar',
                name: 'Antiguedad',
                id:'Antiguedad',
                //disabled : true,
                xtype: 'textfield',
            ...
            },
            {
                xtype: 'fieldset',
                id:'fof',
                title: 'Reportar seg&uacute;n tiempos',
                layout: 'anchor',
                defaults: {
                    anchor: '100%'
                },
...
function promedioedad(){
   ...
   var promedioempresa= this.__data_store = App.BuildJsonStore('Resumenes.Resumenes.promedioempresa', {
    ...
    var promedioareasgrid=Ext.create('Ext.grid.Panel', {
        title: 'Edad Promedio - &Aacute;reas',
        store:  promedioareas,
        columns: [
            { text: '&Aacute;rea',  dataIndex: 'nombre',flex: 1  },
