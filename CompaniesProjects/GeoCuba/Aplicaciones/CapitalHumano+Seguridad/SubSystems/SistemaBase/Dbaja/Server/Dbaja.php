...
class Dbajas extends Module {
    ...
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.dbajas");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Destino de Baja incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.dbajas');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El Destino de Baja '$nombre' ya existe.");
            return false;
        }return true;
       }
