...
class Tcondecoracion extends Module {
    ...
    public function ValidateEliminar(&$params) {
        ...
        $count = $datos->Contains(array('condecoracion_tipoid' => "'$id'"));
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "El Tipo de Condecoración a eliminar esta siendo usado por Condecoración.");
            return false;
        }
    ...
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.condecoracion_tipo");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Tipo de Condecoración incorrecta.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.condecoracion_tipo');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El Tipo de Condecoración '$nombre' ya existe.");
            return false;
        }return true;
       }
    ...
    public function ValidateModid(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Tipo de Condecoración incorrecto.");
            return false;
        }
