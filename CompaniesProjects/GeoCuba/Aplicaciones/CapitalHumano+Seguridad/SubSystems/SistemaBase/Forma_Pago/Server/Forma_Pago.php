...
class Forma_Pago extends Module {
    ...
    // ========================================================================//
     public function ValidateEliminar(&$params) {
        ...
        $count = $datos->Contains(array('fpago_id' => "'$id'"));
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "La Forma de Pago a eliminar está siendo usado por Plantilla.");
            return false;
        }
        return true;
    }
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.forma_pago");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!isset($params['Forma_Pago_nombre_id'])) {
            $this->RegisterError('Parámetro incorrecto', "Parámetro no definido o nulo.");
            return false;
        }

        $nombre = $params['Forma_Pago_nombre_id'];
        ...
        $params['Forma_Pago_nombre_id'] = $nombre;


        $actividades = $this->_dbase->GetTable('nomencladores.forma_pago');
    ...
    public function Add(&$params){
       $name=$params['Forma_Pago_nombre_id'];
       $datos=$this->_dbase->GetTable("nomencladores.forma_pago");
