...
class CPiel extends Module {
    ...
    public function CargarDatos(&$params) {
        ...
        $_limit = $params['limit'];
        $_table = $this->_dbase->GetTable('nomencladores.color_piel');
    ...
    public function ValidateEliminar(&$params) {
        ...
        $count = $datos->Contains(array('color_pielid' => "'$id'"));
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "El Color de Piel a eliminar está siendo usado por Trabajador.");
            return false;
        }
        return true;
    }
    public function Eliminar(&$params) {
        ...
        $result = null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.color_piel");
    ...
    public function ValidateAdd(&$params){
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.color_piel');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El Color de Piel '$nombre' ya existe.");
            return false;
        }return true;
       }
