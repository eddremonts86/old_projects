...
class Overrider extends Module
{
     ...
     public function __construct()
	{
     ...
     public function CreateBackup(&$params)
     {
          ...
          $_hzip = new ZipArchive();
          mkdir($_SESSION['APP_PATH_CDA'] ."/Subsystems/Admin/Subsystems/Backup/Store/" . $_date);
          $_result = $_hzip->open($_SESSION['APP_PATH_CDA'] ."/Subsystems/Admin/Subsystems/Backup/Store/$_date/$_system.zip", ZipArchive::CREATE);
          if(!$_result)
          {
          ...
          if(!$_result)
          {
               unlink($_SESSION['APP_PATH_CDA'] ."/Subsystems/Admin/Subsystems/Backup/Store/$_date/$_system.zip");
               rmdir($_SESSION['APP_PATH_CDA'] ."/Subsystems/Admin/Subsystems/Backup/Store/$_date");
               $this->FreeFlag();
               return false;
          }
