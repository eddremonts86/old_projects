            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Configuración <b
                                    class="caret"></b></a>
            ...
            <div id="carousel-example-generic" style="width: 100%;height: 300px" class="carousel slide" data-ride="carousel">
                <div id="cambio">
                    ...
                    <div class="carousel-inner">
                        <div class="item active" style="background-color: #005f8d;height: 300px"><img height="300"
                                                                                                      src="img/carp0/1.jpg"></i>
                        </div>
                        <div class="item" style="background-color: #04519b;height: 300px"><img height="300"
                                                                                               src="img/carp0/2.jpg">
                        </div>
                        <div class="item" style="background-color: seagreen;height: 300px"><img height="300"
                                                                                                src="img/carp0/3.jpg">
                        </div>
                        <div class="item" style="background-color: #04519b;height: 300px"><img height="300"
                                                                                               src="img/carp0/4.jpg">
            ...
            <div class="column">
                <div class="portlet">
                    <div class="panel panel-default" id="panel_izq_admin">
                        ...
                        <div class="panel-body">
                            <p class="label label-info">¿ Que Opina sobre nuestro sitio ?</p>
                            <div class="radio">
                                <label>
                    ...
                    <span style="float: none; margin-top:-25px">&nbsp;<button type="submit" class="btn btn-info mas btn-sm" id="verMarea">Votar
                        </button></span>
                        </div>
                    </div>
                </div>
