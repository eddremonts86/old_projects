...
function mosGetLink( $mitem, $level, $class_sfx='' ) {
    ...
    if ($mitem->cnt > 0) {
		...
		$random = (rand()%30000000000000);
		    if ($level == 0) {
               $txt = "<span class=\"s5_outer_active\"><span class=\"s5_outer\"><a class=\"active\" id=\"tempID$random\" href=\"$mitem->link\">$mitem->name</a></span></span>";
								$main = "main";
		   } else {
...
function mosShowListMenu($menutype) {
	...
	$indents = array(
			...
			array( "\t\t<ul onmouseover='check_id()'><li class='s5_menutop'></li>", "\t\t\t<li class='noback'>" , '</li>', "\t\t<li class='s5_menubottom'></li></ul>" ),
			array( "\t\t<ul onmouseover='check_id()'>", "\t\t\t<li>" , '</li>', "\t\t<li class='s5_menubottom'></li></ul>" ),
			array( "\t\t\t<ul onmouseover='check_id()'>", "\t\t\t\t<li>" , '</li>', "\t\t\t<li class='s5_menubottom'></li></ul>" ),
			array( "\t\t\t\t<ul onmouseover='check_id()'>", "\t\t\t\t\t<li>" , '</li>', "\t\t\t\t<li class='s5_menubottom'></li></ul>" ),
	);
	$children = array();
