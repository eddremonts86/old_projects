...
<div style="float:left;width:<?php echo $s5_contentwidth ?>px;height:<?php echo $height ?>;overflow:hidden;">
 <div id="s5_button" style="width:<?php echo $s5_contentwidth ?>px;height:<?php echo $height ?>px;">  
