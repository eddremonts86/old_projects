...
Ext.form.MyHtmlEditor = Ext.extend(Ext.form.Field, {
    /**
    ...
    defaultAutoCreate : {
        tag: "textarea",
        style:"width:800px;height:500px;padding:5px 0 5px 5px;",
        autocomplete: "off"
    },
    ...
    // private
    //todo los metodos que sean con las teclas 
...
Ext.reg('MyHtmlEditor', Ext.form.MyHtmlEditor);
