...
com.quizzpot.tutorial.IntegracionTutorial = {
	init: function(){
		...
		equipo = new Ext.form.ComboBox({fieldLabel : "Equipo",anchor:'95%',storedatos:['Mause','Monitor','Spikers','Torre CD/DVD'],bodyStyle:'padding:5px 5px 0',name : "Equipo",hiddenName : "Equipo",id : "Equipo",forceSelection : true,emptyText:'Selecciona Equipo...'});
		...
		var proxy = new Ext.data.HttpProxy({ 
				api: {  
					read    : "../../../clases/envio.php?termino=PendientesHard",   
		...
		var proxy1 = new Ext.data.HttpProxy({ 
				api: {  
					read    : "../../../clases/envio.php?termino=PendientesSoft",   
					create  : "../../../clases/resepcion.php?termino=AltaSolicitud",  
					update  : "../../../clases/resepcion.php?termino=BajaSolicitud",  
					destroy : "../../../clases/resepcion.php?termino=eliminarSolicitud"  
				}  
		...
		this.grid1 = new Ext.grid.GridPanel({   
			...
			items:[
				{items:	[this.grid], title: 'Solicitudes de Hardware - Pendientes'},
				{items:	[this.grid1], title: 'Solicitudes de Software - Pendientes'}				
			]
		});
			var center = {
					xtype	:	"panel",
	...
	failure: function(form,action){  
		...
		success: function(form,action){
				mask.hide();
				Ext.Msg.alert('Datos de modificacion',action.result.msg);
				window.location = 'tecnico.php?termino=Pendientes';	
				 }, 
		failure: function(form,action){  
				mask.hide();
				 switch (action.failureType) { 
		...
		reset:function(){this.form.getForm().reset();window.location = 'tecnico.php?termino=Pendientes';	},
		reset1:function(){formulario1.getForm().reset();window.location = 'tecnico.php?termino=Pendientes';	}	
}
