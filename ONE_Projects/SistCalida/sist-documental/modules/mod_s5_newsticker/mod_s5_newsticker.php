...
<div style="width:<?php echo $width ?>;height:<?php echo $height ?>; overflow:hidden; background:#<?php echo $background ?>">
<center>
<?php if ($text1line != "") { ?>
...
<?php if ($text2line != "") { ?>
<div id="text2" style="padding:0px; display:block;  opacity:.0; <?php if ($iss_ie6 == "yes") { ?>filter: alpha(opacity=0); -moz-opacity: 0;<?php } ?> width:<?php echo $width ?>; overflow:hidden;">
<?php if ($text2line != "") { ?>
<?php echo $text2line ?>
<?php } ?>
</div>
...
<?php if ($text3line != "") { ?>
<div id="text3" style="padding:0px; display:block;  opacity:.0; <?php if ($iss_ie6 == "yes") { ?>filter: alpha(opacity=0); -moz-opacity: 0;<?php } ?> width:<?php echo $width ?>; overflow:hidden;">
<?php if ($text3line != "") { ?>
<?php echo $text3line ?>
<?php } ?>
</div>
...
<?php if ($text4line != "") { ?>
<div id="text4" style="padding:0px; display:block;  opacity:.0; <?php if ($iss_ie6 == "yes") { ?>filter: alpha(opacity=0); -moz-opacity: 0;<?php } ?> width:<?php echo $width ?>; overflow:hidden;">
<?php if ($text4line != "") { ?>
<?php echo $text4line ?>
<?php } ?>
</div>
...
<?php if ($text5line != "") { ?>
<div id="text5" style="padding:0px; display:block;  opacity:.0; <?php if ($iss_ie6 == "yes") { ?>filter: alpha(opacity=0); -moz-opacity: 0;<?php } ?> width:<?php echo $width ?>; overflow:hidden; ">
<?php if ($text5line != "") { ?>
<?php echo $text5line ?>
<?php } ?>
</div>
...
<?php if ($text6line!= "") { ?>
<div id="text6" style="padding:0px; display:block;  opacity:.0; <?php if ($iss_ie6 == "yes") { ?>filter: alpha(opacity=0); -moz-opacity: 0;<?php } ?> width:<?php echo $width ?>; overflow:hidden;">
<?php if ($text6line != "") { ?>
<?php echo $text6line ?>
<?php } ?>
</div>
...
<?php if ($text7line != "") { ?>
<div id="text7" style="padding:0px; display:block;  opacity:.0; <?php if ($iss_ie6 == "yes") { ?>filter: alpha(opacity=0); -moz-opacity: 0;<?php } ?> width:<?php echo $width ?>; overflow:hidden;">
<?php if ($text7line != "") { ?>
<?php echo $text7line ?>
<?php } ?>
</div>
...
<?php if ($text8line != "") { ?>
<div id="text8" style="padding:0px; display:block; opacity:.0; <?php if ($iss_ie6 == "yes") { ?>filter: alpha(opacity=0); -moz-opacity: 0;<?php } ?> width:<?php echo $width ?>; overflow:hidden;">
<?php if ($text8line != "") { ?>
<?php echo $text8line ?>
<?php } ?>
</div>
...
<?php if ($text9line != "") { ?>
<div id="text9" style="padding:0px; display:block;  opacity:.0; <?php if ($iss_ie6 == "yes") { ?>filter: alpha(opacity=0); -moz-opacity: 0;<?php } ?> width:<?php echo $width ?>; overflow:hidden;">.
<?php if ($text9line != "") { ?>
<?php echo $text9line ?>
<?php } ?>
</div>
...
<?php if ($text10line != "") { ?>
<div id="text10" style="padding:0px; display:block;  opacity:.0; <?php if ($iss_ie6 == "yes") { ?>filter: alpha(opacity=0); -moz-opacity: 0;<?php } ?> width:<?php echo $width ?>; overflow:hidden;">
<?php if ($text10line != "") { ?>
<?php echo $text10line ?>
<?php } ?>
</div>
