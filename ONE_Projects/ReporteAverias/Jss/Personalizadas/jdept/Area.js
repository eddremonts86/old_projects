    ...
    com.quizzpot.tutorials.CrudForm = {  	
		init : function() { 
					...
					var proxy = new Ext.data.HttpProxy({ 
						 api: {  
							read    : "../../../clases/envio.php?termino=Area",  
							create  : "../../../clases/resepcion.php?termino=createArea",  
							//update  : "../../clases/resepcion.php?termino=UpdateEquipo",  
							destroy : "../../../clases/resepcion.php?termino=eliminarArea" 
						}  
					}); 
				 ...
				 this.form = new Ext.form.FormPanel({  			  
					 ...
					 url    	 : "../../../clases/resepcion.php?termino=createArea",
					 margins     : "3 3 3 3",  
					 border      : false, 
					 frame:true,	
					 defaults    : {allowBlank: false},  
					 items       : [ {xtype : "textfield", name : "Equipo", fieldLabel : "Equipo nuevo"},],
					 fbar      : [{text : "Agregar Equipo", scope : this,handler: this.datosA,iconCls:'add'}]       
					}); 
				},	
			 	datos:function(){
				...
				var mask = new Ext.LoadMask(Ext.get('grid'),{msg:'Guardando los datos. Por Favor espere...'});
						...
						success: function(form,action){
							...
							window.location = 'jdept.php?termino=Areas';	
							},  
