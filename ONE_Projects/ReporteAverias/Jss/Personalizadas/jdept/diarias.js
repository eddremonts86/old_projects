...
com.quizzpot.tutorial.IntegracionTutorial = {
	init: function(){	 
		var proxy = new Ext.data.HttpProxy({api: { read    : "../../../clases/envio.php?termino=MensualesHard1" }});
		var proxy1 = new Ext.data.HttpProxy({api: {read    : "../../../clases/envio.php?termino=MensualesHardSoluc1"}});	
		var proxy2 = new Ext.data.HttpProxy({api: { read    : "../../../clases/envio.php?termino=MensualesHardPend1" }});		
		var proxy3 = new Ext.data.HttpProxy({api: {read    : "../../../clases/envio.php?termino=MensualesSoft1"}});
		var proxy4 = new Ext.data.HttpProxy({api: { read    : "../../../clases/envio.php?termino=MensualesSoftSoluc1" }});
		var proxy5 = new Ext.data.HttpProxy({api: {read    : "../../../clases/envio.php?termino=MensualesSoftPend1"}});
		...
		var main = new Ext.Panel({
						...
						titleCollapse: true,
						items:	[tabs],
						title: 'Listado de Solicitudes Diarias',					
