    ...
    com.quizzpot.tutorials.area = {  	
		init : function() { 
					...
					var proxy = new Ext.data.HttpProxy({ 
						 api: {  
							read    : "../../../clases/envio.php?termino=Comentario",  
							create  : "createContact.php",  
							update  : "updateContact.php",  
							destroy : "../../../clases/resepcion.php?termino=eliminarComentario" 
						}  
					}); 
					...
					this.store.load({params:{z:30,start:0,limit:3}});  
						...
						pager.on('beforechange',function(bar,params){
						 ...
						 this.grid = new Ext.grid.GridPanel({   
							width:935, 
							title: 'Leer mensajes de contacto',
							 layout:'form',
							 renderTo: 'frame',
							 height:480,							 
							 border: false,  
							...
							columns     : [  
									...
									{header:'comentarioU', dataIndex:'comentarioU',width:400,sortable: true,renderer:this.showDescription},
									],  
							tbar        : [   
			...
			showImage: function(value, metaData, record, rowIndex, colIndex, store){ 
						return '<img src="../../../img/Ext-import/g.ico" alt="'+record.get('breed')+'" style="width: 90px;">';  
						},	
