 <?php
	...
	if(!isset($_SESSION['data'])){
		$data = array( //creates the initial data
			...
			'data'=>array(
				...
				array('id'=>8,'name'=>'Taylor Swift','age'=>19,'country'=>'USA'),
				array('id'=>9,'name'=>'Carlos Mena','age'=>22,'country'=>'México'),
				array('id'=>10,'name'=>'Christiano Ronaldo','age'=>24,'country'=>'Portugal'),
				array('id'=>11,'name'=>'Sasha Cohen','age'=>25,'country'=>'USA'),
				array('id'=>12,'name'=>'Christian Van Der Henst','age'=>27,'country'=>'Guatemala'),
	...
	if(isset($add)){ //if there are records to insert/update
		...
		//$paging = array('success'=>true,'total'=>count($data),'data'=> array_splice($data,$start,$limit));
		//echo json_encode($paging);
		//print the success message
		echo json_encode(array('success'=>true,'total'=>count($data),'data'=> array_splice($data,$start,$limit),'data'=>$ids));
	    }
	else{ 
		//$paging = array('success'=>true,'total'=>count($data),'data'=> array_splice($data,$start,$limit));
		//echo json_encode($paging);
