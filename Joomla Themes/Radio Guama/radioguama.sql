...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-02-2015 a las 22:44:31
...
--
-- Base de datos: `radioguama`
--
CREATE DATABASE IF NOT EXISTS `radioguama` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `radioguama`;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mpg9h_assets`
--

CREATE TABLE IF NOT EXISTS `mpg9h_assets` (
...
--
-- Volcado de datos para la tabla `mpg9h_assets`
--

INSERT INTO `mpg9h_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(54, 18, 70, 71, 2, 'com_modules.module.87', 'Menú superior', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(55, 18, 72, 73, 2, 'com_modules.module.88', 'Redes Sociales', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mpg9h_associations`
--

CREATE TABLE IF NOT EXISTS `mpg9h_associations` (
...
--
-- Estructura de tabla para la tabla `mpg9h_banners`
--

CREATE TABLE IF NOT EXISTS `mpg9h_banners` (
...
--
-- Estructura de tabla para la tabla `mpg9h_banner_clients`
--

CREATE TABLE IF NOT EXISTS `mpg9h_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `mpg9h_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `mpg9h_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `mpg9h_categories`
--

CREATE TABLE IF NOT EXISTS `mpg9h_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `mpg9h_categories`
--

INSERT INTO `mpg9h_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Estructura de tabla para la tabla `mpg9h_contact_details`
--

CREATE TABLE IF NOT EXISTS `mpg9h_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `mpg9h_content`
--

CREATE TABLE IF NOT EXISTS `mpg9h_content` (
...
--
-- Estructura de tabla para la tabla `mpg9h_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `mpg9h_contentitem_tag_map` (
...
--
-- Estructura de tabla para la tabla `mpg9h_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `mpg9h_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `mpg9h_content_rating`
--

CREATE TABLE IF NOT EXISTS `mpg9h_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `mpg9h_content_types`
--

CREATE TABLE IF NOT EXISTS `mpg9h_content_types` (
...
--
-- Volcado de datos para la tabla `mpg9h_content_types`
--

INSERT INTO `mpg9h_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Estructura de tabla para la tabla `mpg9h_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `mpg9h_core_log_searches` (
...
--
-- Estructura de tabla para la tabla `mpg9h_extensions`
--

CREATE TABLE IF NOT EXISTS `mpg9h_extensions` (
...
--
-- Volcado de datos para la tabla `mpg9h_extensions`
--

INSERT INTO `mpg9h_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"334e6e8e877ef03271dd615e1f17bb45"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10000, 'gk_gamenews', 'template', 'gk_gamenews', '', 0, 1, 1, 0, '{"name":"gk_gamenews","type":"template","creationDate":"06 Nov 2013","author":"GavickPro","copyright":"Copyright (C) 2007 - 2012 GavickPro. All rights reserved.","authorEmail":"support@gavick.com","authorUrl":"http:\\/\\/gavick.com","version":"3.10","description":"\\n\\t\\t\\t\\t<link rel=\\"stylesheet\\" type=\\"text\\/css\\" href=\\"..\\/templates\\/gk_gamenews\\/admin\\/style.css\\" \\/>\\n\\t\\t\\t\\t\\t\\t<style type=\\"text\\/css\\" media=\\"all\\">\\n\\t\\t\\t\\t\\t\\t<!--\\n\\t\\t\\t\\t\\t\\t#wrap1 {padding:0px 0px 4px 0px;}\\n\\t\\t\\t\\t\\t\\t#wrap1 h1 {clear:both;font-family: Georgia, sans-serif;font-size:38px;margin:30px 20px 12px ;padding:0px 0px 24px 10px;color:#333; border-bottom: 1px solid #ccc; font-weight: normal;}\\n\\t\\t\\t\\t\\t\\t#wrap1 h4 { border: none;  margin: 0 0 12px; padding:0; font: italic 20px\\/32px Georgia, sans-serif; color: #333; }\\n\\t\\t\\t\\t\\t\\t#wrap1 sup { font-style: italic; font-size: }\\n\\t\\t\\t\\t\\t\\t#wrap1 .wrap2 {background:#fff;padding: 20px; font-family: Arial; font-size:13px; text-align: justify; color: #4d4d4d; line-height: 24px;}\\n\\t\\t\\t\\t\\t\\t#wrap1 .leftart {margin: 16px 0 0 176px; font-weight:normal!important; }\\n\\t\\t\\t\\t\\t\\t#wrap1 .livedemo { margin-top: 28px; }\\n\\t\\t\\t\\t\\t\\t-->\\n\\t\\t\\t\\t\\t\\t<\\/style>\\t\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\t<div id=\\"wrap1\\">    \\n\\t\\t\\t\\t\\t\\t<h1><em>GameNews<\\/em><\\/h1>\\n\\t\\t\\t\\t\\t\\t<div class=\\"wrap2\\">                    \\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\t<a title=\\"Visit the official website!\\" href=\\"http:\\/\\/demo.gavick.com\\/index.php?year=2012&month=aug&joomla=16\\" target=\\"_blank\\"> <img style=\\"padding-left: 10px;float: left; background-color: #fff;\\" src=\\"..\\/templates\\/gk_gamenews\\/images\\/template_image.jpg\\" border=\\"0\\" alt=\\"Logo\\" \\/><\\/a>       \\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\t<div class=\\"leftart\\">            \\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\t<h4>Game Portal Joomla Template <\\/h4>\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\t<p>Don\\u2019t retreat from the game.  Instead, defeat the enemy with the breathtaking design of your game news website!<\\/p>\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\t<p>This month we deliver a wonderful Joomla news template dedicated to game lovers everywhere!\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\tIf you are seeking a unique look for your Joomla website, look no further - use the GameNews template and make an impression.\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\t<p>Are you considering how you might build a news website? Check out one of the best Joomla game templates out there!\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\tSimplify your work, and present news and reviews with ease.  Your job is made much easier through use of our amazing free Joomla modules: News Show Pro GK4, Tabs GK5 and K2, all of which are supported in this gaming website template!<\\/p>\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\t<p>This latest product features native support for Responsive Web Design, making this already powerful Joomla template even more special.\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\tAs if that wasn''t enough, we''ve even implemented new elements and icons in this template.<\\/p>\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\t<p>In addition to all of the above, we''ve added a top bar similar to the one seen on the  GavickPro homepage.  This was in response to the many queries we''ve received from our to have this implemented. So, added specially for you, here it is!<\\/p>\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\t<p>So, go for it: create that dazzling Web project you''ve been dreaming of and make it a success based upon this wonderful game themed template for Joomla!<\\/p>\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\t<p class=\\"livedemo\\">View GameNews template in action <a href=\\"http:\\/\\/demo.gavick.com\\/index.php?year=2012&month=aug&joomla=16\\" target=\\"_blank\\">here<\\/a>...<\\/p><small>Gavern v.3.10<\\/small><\\/div>\\n\\t\\t\\t\\t\\t\\t<\\/div>\\n\\t\\t\\t\\t\\t\\t<\\/div>\\n\\t\\t","group":""}', '{"template_color":"1","template_bg":"1","default_layout":"default","layout_body_space":"20","template_width":"1020","tablet_width":"900","mobile_width":"540","sidebar_position":"right","sidebar_width":"30","rwd":"1","logo_type":"image","logo_image":"","logo_text":"","logo_slogan":"","print_logo":"","print_behaviour":"1","favicon_image":"","touch_image":"","register_link":"1","stylearea":"1","framework_logo":"1","webmaster_contact_type":"1","webmaster_contact":"webmaster@gavick.com","typography":"0","typo_iconset":"0","tools":"1","startlevel":"0","endlevel":"-1","menu_animation":"slide","menu_height":"0","menu_width":"0","menu_col_width":"200","menu_duration":"500","fb_api_id":"","fb_lang":"en_US","fb_login":"0","fb_like":"0","fb_like_send":"0","fb_like_layout":"standard","fb_like_show_faces":"true","fb_like_width":"500","fb_like_action":"like","fb_like_font":"arial","fb_like_colorscheme":"light","google_plus":"1","google_plus_count":"1","google_plus_size":"medium","google_plus_lang":"en-GB","google_plus_share":"1","google_plus_share_annotation":"vertical-bubble","google_plus_share_size":"20","tweet_btn":"0","tweet_btn_data_count":"vertical","tweet_btn_data_via":"","tweet_btn_data_lang":"en","pinterest_btn":"0","pinterest_btn_style":"horizontal","excluded_cats":"","cookie_consent":"0","consenttype":"explicit","cookie_latest_version":"0","cookie_use_ssl":"0","banner_position":"bottom","banner_tag_placement":"bottom-right","cookie_style":"light","refreshOnConsent":"0","cookiecss":"1","use_gk_cache":"0","css_cache":"0","css_compression":"0","css_override":"0","css_prefixer":"0","js_compression":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10001, 'SpanishES', 'language', 'es-ES', '', 0, 1, 0, 0, '{"name":"Spanish (ES)","type":"language","creationDate":"2014-9-28","author":"Spanish Translation Team: Comunidad Joomla","copyright":"Copyright (C) 2005 - 2014 Open Source Matters and comunidadjoomla.org. All rights reserved.","authorEmail":"info@comunidadjoomla.org","authorUrl":"www.comunidadjoomla.org","version":"3.3.4.1","description":"Spanish language pack for Joomla! 3.3.4 - Site","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10002, 'SpanishES', 'language', 'es-ES', '', 1, 1, 0, 0, '{"name":"Spanish (ES)","type":"language","creationDate":"2014-9-28","author":"Spanish Translation Team: Comunidad Joomla","copyright":"Copyright (C) 2005 - 2014 Open Source Matters and comunidadjoomla.org. All rights reserved.","authorEmail":"info@comunidadjoomla.org","authorUrl":"www.comunidadjoomla.org","version":"3.3.4.1","description":"Spanish language pack for Joomla! 3.3.4 - Administrator","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10003, 'es-ES', 'package', 'pkg_es-ES', '', 0, 1, 1, 0, '{"name":"Spanish Language Pack","type":"package","creationDate":"28 de septiembre del 2014","author":"Spanish Translation Team: comunidadjoomla.org","copyright":"Copyright (C) 2005 - 2014 comunidadjoomla.org and Open Source Matters. All rights reserved.","authorEmail":"info@comunidadjoomla.org","authorUrl":"www.comunidadjoomla.org","version":"3.3.4.1","description":"\\n\\t\\t<div style=\\"text-align:left;\\">\\n\\t\\t<h2>Successfully installed the spanish language pack for Joomla! 3.3.4.<\\/h2>\\n\\t\\t<p><\\/p>\\n\\t\\t<p>Please report any bugs or issues at the Comunidad Joomla! <a href=\\"http:\\/\\/foro.comunidadjoomla.org\\/traduccion-ext\\/\\" target=\\"_blank\\">Translation forum<\\/a><\\/p>\\n\\t\\t<p><\\/p>\\n\\t\\t<p>Translated by: <a href=\\"http:\\/\\/www.comunidadjoomla.org\\" target=\\"_blank\\" title=\\"\\">The spanish translation team of Comunidad Joomla!<\\/a><\\/p>\\n\\t\\t<h2>El paquete en espa\\u00f1ol para Joomla! 3.3.4 se ha instalado correctamente.<\\/h2>\\n\\t\\t<p><\\/p>\\n\\t\\t<p>Por favor, reporte cualquier bug o asunto relacionado a nuestro <a href=\\"http:\\/\\/foro.comunidadjoomla.org\\/traduccion-ext\\/\\" target=\\"_blank\\">Foro de traducciones<\\/a><\\/p>\\n\\t\\t<p><\\/p>\\n\\t\\t<p>Traducci\\u00f3n: <a href=\\"http:\\/\\/www.comunidadjoomla.org\\" target=\\"_blank\\" title=\\"\\">El equipo de traducci\\u00f3n de Comunidad Joomla!<\\/a><\\/p>\\n\\t\\t<\\/div>\\n\\t\\t","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mpg9h_finder_filters`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_filters` (
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links` (
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_terms0` (
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Volcado de datos para la tabla `mpg9h_finder_taxonomy`
--

INSERT INTO `mpg9h_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mpg9h_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_terms`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_terms` (
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Volcado de datos para la tabla `mpg9h_finder_terms_common`
--

INSERT INTO `mpg9h_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `mpg9h_finder_types`
--

CREATE TABLE IF NOT EXISTS `mpg9h_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `mpg9h_languages`
--

CREATE TABLE IF NOT EXISTS `mpg9h_languages` (
...
--
-- Volcado de datos para la tabla `mpg9h_languages`
--

INSERT INTO `mpg9h_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mpg9h_menu`
--

CREATE TABLE IF NOT EXISTS `mpg9h_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `mpg9h_menu`
--

INSERT INTO `mpg9h_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(101, 'mainmenu', 'Portada', 'portada', '', 'portada', 'index.php?option=com_content&view=featured', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"featured_categories":[""],"layout_type":"blog","num_leading_articles":"1","num_intro_articles":"3","num_columns":"3","num_links":"0","multi_column_order":"1","orderby_pri":"","orderby_sec":"front","order_date":"","show_pagination":"2","show_pagination_results":"1","show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_tags":"","show_noauth":"","show_feed_link":"1","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":1,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 47, 48, 1, '*', 0),
(102, 'mainmenu', 'Pinar del Río', 'pinar-del-rio', '', 'pinar-del-rio', '', 'component', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 49, 58, 0, '*', 0),
(103, 'mainmenu', 'Economía', 'economia', '', 'pinar-del-rio/economia', '', 'component', 1, 102, 2, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 50, 51, 0, '*', 0),
(104, 'mainmenu', 'Cultura y Sociedad', 'cultura-y-sociedad', '', 'pinar-del-rio/cultura-y-sociedad', '', 'component', 1, 102, 2, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 52, 53, 0, '*', 0),
(105, 'mainmenu', 'Ciencia y Tecnología', 'ciencia-y-tecnologia', '', 'pinar-del-rio/ciencia-y-tecnologia', '', 'component', 1, 102, 2, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 54, 55, 0, '*', 0),
(106, 'mainmenu', 'Deportes', 'deportes', '', 'pinar-del-rio/deportes', '', 'component', 1, 102, 2, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 56, 57, 0, '*', 0),
(107, 'mainmenu', 'Cuba', 'cuba', '', 'cuba', '#', 'url', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1}', 59, 60, 0, '*', 0),
(108, 'mainmenu', 'El Mundo', 'el-mundo', '', 'el-mundo', '', 'component', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 61, 62, 0, '*', 0),
(109, 'mainmenu', 'Programas', 'programas', '', 'programas', '', 'component', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 63, 64, 0, '*', 0),
(110, 'mainmenu', 'Especiales', 'especiales', '', 'especiales', '', 'component', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 65, 74, 0, '*', 0),
(111, 'mainmenu', 'Servicios', 'servicios', '', 'servicios', '', 'component', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 75, 76, 0, '*', 0),
(112, 'mainmenu', 'Enfoques', 'enfoques', '', 'especiales/enfoques', '', 'component', 1, 110, 2, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 66, 67, 0, '*', 0),
(113, 'mainmenu', 'Vidas', 'vidas', '', 'especiales/vidas', '', 'component', 1, 110, 2, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 68, 69, 0, '*', 0),
(114, 'mainmenu', 'Otros lenguajes', 'otros-lenguajes', '', 'especiales/otros-lenguajes', '', 'component', 1, 110, 2, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 70, 71, 0, '*', 0),
(115, 'mainmenu', 'Apuntes históricos', 'apuntes-historicos', '', 'especiales/apuntes-historicos', '', 'component', 1, 110, 2, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 72, 73, 0, '*', 0),
(116, 'menusuperior', 'Portada', 'inicio', '', 'inicio', '', 'component', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 77, 78, 0, '*', 0),
(117, 'menusuperior', 'Mapa del sitio', 'mapa-del-sitio', '', 'mapa-del-sitio', '', 'component', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 79, 80, 0, '*', 0),
(118, 'menusuperior', 'Postcast', 'postcast', '', 'postcast', '', 'component', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 81, 82, 0, '*', 0),
(119, 'menusuperior', 'FAQ', 'faq', '', 'faq', '', 'component', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 83, 84, 0, '*', 0),
(120, 'menusuperior', 'Quienes somos', 'quienes-somos', '', 'quienes-somos', '', 'component', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 85, 86, 0, '*', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mpg9h_menu_types`
--

CREATE TABLE IF NOT EXISTS `mpg9h_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `mpg9h_menu_types`
--

INSERT INTO `mpg9h_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Menú principal', 'Este es el menú principal del sitio'),
(2, 'menusuperior', 'Menú superior', 'Menú superior del sitio en negro');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mpg9h_messages`
--

CREATE TABLE IF NOT EXISTS `mpg9h_messages` (
...
--
-- Estructura de tabla para la tabla `mpg9h_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `mpg9h_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `mpg9h_modules`
--

CREATE TABLE IF NOT EXISTS `mpg9h_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Volcado de datos para la tabla `mpg9h_modules`
--

INSERT INTO `mpg9h_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(87, 54, 'Menú superior', '', '', 0, 'topnav', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"menusuperior","base":"","startLevel":"1","endLevel":"0","showAllChildren":"1","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(88, 55, 'Redes Sociales', '', '<p><a class="gkFb" href="#">Facebook</a> <a class="gkTwitter" href="#">Twitter</a> <a class="gkGplus" href="#">Google+</a> <a class="gkRss" href="#">RSS</a></p>', 1, 'social', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 1, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mpg9h_modules_menu`
--

CREATE TABLE IF NOT EXISTS `mpg9h_modules_menu` (
...
--
-- Volcado de datos para la tabla `mpg9h_modules_menu`
--

INSERT INTO `mpg9h_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `mpg9h_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `mpg9h_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `mpg9h_overrider`
--

CREATE TABLE IF NOT EXISTS `mpg9h_overrider` (
...
--
-- Estructura de tabla para la tabla `mpg9h_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `mpg9h_postinstall_messages` (
...
--
-- Volcado de datos para la tabla `mpg9h_postinstall_messages`
--

INSERT INTO `mpg9h_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `mpg9h_redirect_links`
--

CREATE TABLE IF NOT EXISTS `mpg9h_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `mpg9h_schemas`
--

CREATE TABLE IF NOT EXISTS `mpg9h_schemas` (
...
--
-- Volcado de datos para la tabla `mpg9h_schemas`
--

INSERT INTO `mpg9h_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.3.6-2014-09-30');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mpg9h_session`
--

CREATE TABLE IF NOT EXISTS `mpg9h_session` (
...
--
-- Volcado de datos para la tabla `mpg9h_session`
--

INSERT INTO `mpg9h_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('84kfn4hanish5l7t37c1a2q593', 1, 0, '1423258560', '__default|a:9:{s:15:"session.counter";i:125;s:19:"session.timer.start";i:1423251471;s:18:"session.timer.last";i:1423258557;s:17:"session.timer.now";i:1423258559;s:22:"session.client.browser";s:72:"Mozilla/5.0 (Windows NT 6.2; WOW64; rv:35.0) Gecko/20100101 Firefox/35.0";s:8:"registry";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":5:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:9:"com_menus";O:8:"stdClass":2:{s:4:"edit";O:8:"stdClass":2:{s:4:"item";O:8:"stdClass":5:{s:2:"id";a:0:{}s:4:"data";N;s:4:"type";N;s:4:"link";N;s:8:"menutype";s:12:"menusuperior";}s:4:"menu";O:8:"stdClass":2:{s:4:"data";N;s:2:"id";a:0:{}}}s:5:"items";O:8:"stdClass":3:{s:8:"menutype";s:8:"mainmenu";s:10:"limitstart";i:0;s:4:"list";a:4:{s:9:"direction";s:3:"asc";s:5:"limit";s:2:"20";s:8:"ordering";s:5:"a.lft";s:5:"start";d:0;}}}s:4:"item";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:8:"menutype";s:8:"mainmenu";}}s:11:"com_modules";O:8:"stdClass":3:{s:7:"modules";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:18:"client_id_previous";i:0;}}s:4:"edit";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:4:"data";N;s:2:"id";a:0:{}}}s:3:"add";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:12:"extension_id";N;s:6:"params";N;}}}s:13:"com_templates";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:5:"style";O:8:"stdClass":2:{s:2:"id";a:0:{}s:4:"data";N;}}}}}s:4:"user";O:5:"JUser":27:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"325";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:18:"osmay8510@yahoo.es";s:8:"password";s:60:"$2y$10$8hGL5BfsWKOdDiS4F71oyumOW9jHHeezi5ldBBzVyu8rra7V2vdqi";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2015-02-06 19:31:15";s:13:"lastvisitDate";s:19:"2015-02-06 19:37:49";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:12:"requireReset";s:1:"0";s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"1c445299edeec296184ec1a7cfe80d27";s:20:"com_media.return_url";s:121:"index.php?option=com_media&view=images&tmpl=component&fieldid=jform_params_logo_image&e_name=&asset=com_templates&author=";}', 325, 'admin'),
('904uka9d4cenhtcdmml2dh03i5', 0, 1, '1423258553', '__default|a:7:{s:15:"session.counter";i:41;s:19:"session.timer.start";i:1423253173;s:18:"session.timer.last";i:1423258548;s:17:"session.timer.now";i:1423258552;s:22:"session.client.browser";s:72:"Mozilla/5.0 (Windows NT 6.2; WOW64; rv:35.0) Gecko/20100101 Firefox/35.0";s:8:"registry";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}}', 0, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mpg9h_tags`
--

CREATE TABLE IF NOT EXISTS `mpg9h_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `mpg9h_tags`
--

INSERT INTO `mpg9h_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mpg9h_template_styles`
--

CREATE TABLE IF NOT EXISTS `mpg9h_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `mpg9h_ucm_content`
--

CREATE TABLE IF NOT EXISTS `mpg9h_ucm_content` (
...
--
-- Estructura de tabla para la tabla `mpg9h_ucm_history`
--

CREATE TABLE IF NOT EXISTS `mpg9h_ucm_history` (
...
--
-- Estructura de tabla para la tabla `mpg9h_updates`
--

CREATE TABLE IF NOT EXISTS `mpg9h_updates` (
...
--
-- Estructura de tabla para la tabla `mpg9h_update_sites`
--

CREATE TABLE IF NOT EXISTS `mpg9h_update_sites` (
...
--
-- Volcado de datos para la tabla `mpg9h_update_sites`
--

INSERT INTO `mpg9h_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 0, 0, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 0, 1423251482, ''),
...
--
-- Estructura de tabla para la tabla `mpg9h_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `mpg9h_update_sites_extensions` (
...
--
-- Volcado de datos para la tabla `mpg9h_update_sites_extensions`
--

INSERT INTO `mpg9h_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(3, 10003),
...
--
-- Estructura de tabla para la tabla `mpg9h_usergroups`
--

CREATE TABLE IF NOT EXISTS `mpg9h_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla `mpg9h_usergroups`
--

INSERT INTO `mpg9h_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla `mpg9h_users`
--

CREATE TABLE IF NOT EXISTS `mpg9h_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Volcado de datos para la tabla `mpg9h_users`
--

INSERT INTO `mpg9h_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(325, 'Super User', 'admin', 'osmay8510@yahoo.es', '$2y$10$8hGL5BfsWKOdDiS4F71oyumOW9jHHeezi5ldBBzVyu8rra7V2vdqi', 0, 1, '2015-02-06 19:31:15', '2015-02-06 19:37:56', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mpg9h_user_keys`
--

CREATE TABLE IF NOT EXISTS `mpg9h_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `mpg9h_user_notes`
--

CREATE TABLE IF NOT EXISTS `mpg9h_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `mpg9h_user_profiles`
--

CREATE TABLE IF NOT EXISTS `mpg9h_user_profiles` (
...
--
-- Estructura de tabla para la tabla `mpg9h_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `mpg9h_user_usergroup_map` (
...
--
-- Volcado de datos para la tabla `mpg9h_user_usergroup_map`
--

INSERT INTO `mpg9h_user_usergroup_map` (`user_id`, `group_id`) VALUES
(325, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mpg9h_viewlevels`
--

CREATE TABLE IF NOT EXISTS `mpg9h_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Volcado de datos para la tabla `mpg9h_viewlevels`
--

INSERT INTO `mpg9h_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Estructura de tabla para la tabla `mpg9h_weblinks`
--

CREATE TABLE IF NOT EXISTS `mpg9h_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
