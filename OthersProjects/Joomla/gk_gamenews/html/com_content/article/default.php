...
<article class="item-page<?php echo $this->pageclass_sfx?>">
	...
	<header>
		...
		<ul>	
			...
			<li class="published">
				<time datetime="<?php echo JHtml::_('date', $this->item->publish_up, JText::_('DATE_FORMAT_LC2')); ?>">
					<?php echo JHtml::_('date', $this->item->publish_up, JText::_('d M Y h:i')); ?>
				</time>
			</li>			
			<?php elseif ($params->get('show_modify_date')) : ?>
			<li class="modified">
				<time datetime="<?php echo JHtml::_('date', $this->item->modified, JText::_('DATE_FORMAT_LC2')); ?>">
					<?php echo JHtml::_('date', $this->item->modified, JText::_('d M Y h:i')); ?>
				</time>
			</li>
			<?php elseif ($params->get('show_create_date')) : ?>
			<li class="created">
				<time datetime="<?php echo JHtml::_('date', $this->item->created, JText::_('DATE_FORMAT_LC2')); ?>">
