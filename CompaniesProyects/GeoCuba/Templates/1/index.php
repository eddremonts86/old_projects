...
<!--==========================================Panel Izquierdo===================================================-->
    ...
    <div style="min-width: 100%">
        <div class="column">
            <div class="portlet">
                <div class="panel panel-success" id="panel_izq">
                    <div class="panel-heading" style="margin: -1px">
    ...
    <div class="column" id="Noti">
        ...
        <div class="portlet">
            <div class="col-lg-1211">
                <div class="panel panel-default" id="panel_chart">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i> Comportamiento de las Reservas
        ...
        <div class="portlet">
            <div class="col-lg-1211">
                <div class="panel panel-default" id="panel_chart">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i>  INDICADORES DEL CLIMA EN CUBA
                    <span style="float: right; margin-top:0px;padding:3px 0 20px 40px; ">&nbsp;&nbsp;&nbsp;<button
                            style="color: #033c73;" type="button" class="close" data-dismiss="modal"
                            aria-hidden="true" id="boton_panel_chart">×
                        </button></span>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="">
                                ...
                                <tr>
                                    <th> </th>
                                    <th>Ene<i class="fa fa-sort"></i></th>
                                    <th>Feb<i class="fa fa-sort"></i></th>
                                    <th>Mar <i class="fa fa-sort"></i></th>
                                    <th>Abr <i class="fa fa-sort"></i></th>
                                    <th>May <i class="fa fa-sort"></i></th>
                                    <th>Jun <i class="fa fa-sort"></i></th>
                                    <th>Jul <i class="fa fa-sort"></i></th>
                                    <th>Ago <i class="fa fa-sort"></i></th>
                                    <th>Sept <i class="fa fa-sort"></i></th>
                                    <th>Obt <i class="fa fa-sort"></i></th>
                                    <th>Nov <i class="fa fa-sort"></i></th>
                                    <th>Dic <i class="fa fa-sort"></i></th>
