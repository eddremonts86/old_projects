...
class NJuridica extends Module {
    ...
    public function ValidateEliminar(&$params) {
        ...
        $count = $datos->Contains(array('norma_juridicaid' => "'$id'"));
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "La Norma Jurídica a eliminar esta siendo usado por Cargo.");
            return false;
        }
        return true;
    }
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.norma_juridica");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Nombre de la Norma Jurídica  incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.norma_juridica');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "La Norma Jurídica '$nombre' ya existe.");
            return false;
        }return true;
       }
