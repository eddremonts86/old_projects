...
class Ecivil extends Module {
    ...
    public function CargarDatos(&$params) {
        ...
        $_limit = $params['limit'];
        $_table = $this->_dbase->GetTable('nomencladores.estado_civil');
    ...
    public function ValidateEliminar(&$params) {
        ...
        $count = $datos->Contains(array('estado_civilid' => "'$id'"));
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "El Estado Civil a eliminar está siendo usado por Trabajador.");
            return false;
        }
        return true;
    }
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.estado_civil");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Nombre del Estado Civil incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.estado_civil');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El Estado Civil '$nombre' ya existe.");
            return false;
        }return true;
       }
