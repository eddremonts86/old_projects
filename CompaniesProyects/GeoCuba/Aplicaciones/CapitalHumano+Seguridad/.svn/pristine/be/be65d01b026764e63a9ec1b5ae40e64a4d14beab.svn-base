...
App.RegisterFunction('ImportXLS', new ImportXLSGestionar());

ImportXLS.prototype.OnShowWindow = function(_paccion){
    var _value_nom = null;
    var fileup = null;
...
ImportXLS.prototype.OnShowWindow2 = function(_paccion){
    var _value_nom_oll = null;
    var id_tpo,descripcion,anno=null;
    var _selectionModel = Ext.getCmp('ImportXLS_grid_id').getSelectionModel();
...
ImportXLS.prototype.Modid = function(_paccion,_selectionModel,_selected_rcd){
    App.ShowMsgBox(Ext.Msg.wait('Por favor, espere un momento','Procesando...'));
    var _result = App.PerformSyncServerRequest('ImportXLS.ImportXLS.Modid',this.panelupd.getForm().getValues());
    App.HideMsgBox();
...
ImportXLS.prototype.upfiles = function(_p_form, _p_accion, fileup) {
    if ( this.panel.getForm().isValid()) {
        function fnCallBack(){
                    ...
                    if (_p_accion == 'upd') {
                        Ext.getCmp('_gst_Udt_win_id').close();
                        App.InfoMessage('Información', 'ImportXLS modificado satisfactoriamente...');
                    }
                    else
        ...
        //App.ShowMsgBox(Ext.Msg.wait('Por favor, espere un momento','Procesando...'));
        if (_p_accion == 'add'){
            App.UploadFile('ImportXLS.ImportXLS.Adicionar',this.panel.getForm(), Ext.bind(fnCallBack,this));
        }
        else{
            App.UploadFile('ImportXLS.ImportXLS.Update', this.panel.getForm(), Ext.bind(fnCallBack,this));
        }
...
ImportXLS.prototype.deltect = function(_paccion){
    ...
    var fnCallBack = function() {
        ...
        App.ShowMsgBox(Ext.Msg.wait('Por favor, espere un momento', 'Procesando...'));
        _result = App.PerformSyncServerRequest('ImportXLS.ImportXLS.Eliminar', {dir: dir,id: id,nombre_file:nombre_file});
        App.HideMsgBox();
