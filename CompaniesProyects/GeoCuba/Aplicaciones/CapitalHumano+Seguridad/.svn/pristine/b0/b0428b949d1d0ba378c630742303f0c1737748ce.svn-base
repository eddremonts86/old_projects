        ...
        tbar.add({ xtype: 'button', text: 'Buscar', iconCls:'go_last16',handler:function(){
            ...
            if(causas==1){
                ...
                grid.reconfigure(this.__data_store, [
                    ...
                    {text: 'Datos del Cuadro', flex: 2, xtype:'templatecolumn', tpl:"<b>Cuadro:</b> "+'{nombre_completo}'+"<br>"+"<b>Fecha de Reactivacion:</b> "+'({fecha_re})'+"<br><b>Descripcion:</b> "+'{descripcion}'},
                    {text: 'Datos de la Violacion', flex: 2, xtype:'templatecolumn', tpl:"<b>Tipo de Violacion:</b> "+'{nombre}'+"<br>"+"<b>Fecha:</b> "+'({fecha})'}
                ...
                grid.reconfigure(this.__data_store, [
                    ...
                    {text: 'Datos del Cuadro', flex: 2, xtype:'templatecolumn', tpl:"<b>Cuadro:</b> "+'{nombre_completo}'+"<br>"+"<b>Fecha de Reactivacion:</b> "+'({fecha_reactivacion})'+"<br><b>Descripcion:</b> "+'{descrip}'},
