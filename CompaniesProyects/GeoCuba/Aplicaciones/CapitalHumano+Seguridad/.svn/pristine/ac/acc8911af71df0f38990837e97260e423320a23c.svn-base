function AprobS(){
    ...
    {                   
        ...
        {
            text: 'Aprobacion de Solicitudes',
            id: 'AprobS_menu_id1',
    ...
    //-------------------------------------Aprobar Solicitudes---------------------------------------------
       ...
       var _grid_cursos = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {text: "Accion",xtype:'actioncolumn', width:70}
            ],
            enableLocking: true,
            width: '100%',
            height:380,
                   ...
                   Ext.create('Ext.window.Window', {
                       ...
                       html:
                           '<ul class="nav nav-list">' +
                               ...
                               '<br>Los trabajadores aparecen con su Agencia y area para diferenciar cada contrato que tenga un trabajado especial.<br>' +
    ...
    //--------------------------------------------Necesidades de Aprendisaje Personales----------------------------------------
       ...
       this.solicituedes = App.BuildJsonStore('AprobS.AprobS.Solicitud',{
                        ...
                        Ext.create('Ext.window.Window', {
                            ...
                            html:
                                '<ul class="nav nav-list">' +
                                    ...
                                    '<span class="label label-warning">Debe saber que :</span>' +
                                    '<br>Los trabajadores en caracter individual pueden necesistar mas de un curso estos deben ser adicionados a el apartado ' +
        ...
        var Aprobar_cursos = new Ext.Panel({
            title: 'Necesidades de Aprendizaje <div class="label label-info"> Personales </div>y Gestion de  Eventos',
            border: true,
            frame: true,
            layout: 'border',
        ...
        var toolB_Necesidades=Ext.create('Ext.toolbar.Toolbar', {
            ...
            items: [
              ...
              /*  {
                    xtype: 'textfield',
                    name: 'searchField_Aprb_cursos5_necs',
                    id:'searchField_Aprb_cursos5_necs',
                    hideLabel: true,
                    width: 200,
                    emptyText:'Filtrar por: Cursos...',
                    listeners: {
                        change:function(){
                            Ext.getCmp('_grid_cursos_gestion').store.clearFilter();
                            Ext.getCmp('_grid_cursos_gestion').store.filter("nombre", Ext.getCmp('searchField_Aprb_cursos_necs').getValue());
                        },scope:this
                    }
                },'-','->',*/
                {
