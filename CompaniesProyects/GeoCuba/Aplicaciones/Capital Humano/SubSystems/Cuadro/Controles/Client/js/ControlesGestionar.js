function ControlesGestionar()
{
    ...
    this.Render = function(Panel){
        this._btn_add = Ext.create('Ext.Button',{
            text: 'Adicionar',
            id: 'add_Controles__bt_id_',
            //tooltip : 'Adiciona un  nuevo Controles',
            tooltip:'<a rel="tooltip" href="#" data-original-title="Default tooltip">Adicionar Control</a>',
            iconCls: 'list_add16',
            handler: Ext.Function.bind(this.Owner.OnShowWindowcp, this.Owner,['add'])
        });
        this._btn_del = Ext.create('Ext.Button',{
            text: 'Eliminar',
            id: 'del_Controles_btn_id_',
        ...
        this._btn_mod_res= Ext.create('Ext.Button', {
            text: 'Informacion',
            id: 'mod_controles_btn_id_',
            tooltip : 'Historial de Controles',
            iconCls: 'apply16',
            disabled: false,
