...
class Controles extends Module {
    ...
    public function CargarDatos(&$params) {
        ...
        $_limit = $params['limit'];
        $_table = $this->_dbase->GetTable('cuadro.controles');
    ...
    public function controles1(&$params) {
        ...
        $_limit = $params['limit'];
        $id = $params['id'];
        $_table = $this->_dbase->GetTable('vistas_resumen.cuadros_controles_h');
...
//        }
    ...
    public function Add(&$params){
       ...
       $datos=$this->_dbase->GetTable("cuadro.controles");
       return $data=$datos->InsertValues(array('nombre' => "'$name'",'fecha' => "'$from_date'",'ejecutor' => "'$ejecurto'"));
