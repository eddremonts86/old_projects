                ...
                handler:function(This){
                    ...
                    if(id == null || id==''){
                        ...
                        var fnCallBack = function()   {
                            ...
                            {
                                Ext.getCmp('mod_grid_ind').store.remove(record);
                                App.InfoMessage('Información', 'Sistema de Pago modificado satisfactoriamente');
                            }
                            else
                            {
            ...
            },
            {
                ...
                handler: function(){
                    ...
                    else
                    {
                        ...
                        {
                            var nomb = mydd[i].getData().nombre;
                            var ord = parseInt(mydd[i].getData().orden);
                            console.log (ord);
                            if(isNaN(ord)==true && nomb=="" ||nomb== null||nomb=="Nuevo Indicador")
                            {
                                si=0;
                                App.InfoMessage('Información', 'Debe llenar los campos correctamente');
                                return;
                            }
                            else
