...
class LProcedencia extends Module {
    ...
    public function ValidateEliminar(&$params) {
        ...
        $count = $datos->Contains(array('lugar_procedenciaid' => "'$id'"));
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "El Lugar de Procedencia a eliminar está siendo usado por Trabajador.");
            return false;
        }
        return true;
    }
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.lugar_procedencia");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Nombre del Lugar de Procedencia incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.lugar_procedencia');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El Lugar de Procedencia '$nombre' ya existe.");
            return false;
        }return true;
       }
