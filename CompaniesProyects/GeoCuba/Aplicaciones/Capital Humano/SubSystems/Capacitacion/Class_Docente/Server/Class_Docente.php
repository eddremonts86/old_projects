...
class Class_Docente extends Module {
    ...
    public function ValidateEliminar(&$params) {
        ...
        $count = $datos->Contains(array('categoria_docente_id' => "'$id'"));
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "El Class_Docente a eliminar esta siendo usado por Contrato.");
            return false;
        }
        return true;
    }
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.categoria_docente");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Nombre de la categoría docente incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.categoria_docente');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "La categoría docente '$nombre' ya existe.");
            return false;
        }return true;
       }
