function HClinicaGestionar()
{
    ...
    this.Render = function(Panel){
        this._btn_add = Ext.create('Ext.Button',{
            text: 'Adicionar',
            id: 'add_HClinica_btn_id',
            tooltip : 'Adiciona un nuevo HClinica de Protecci&oacute;n',
            iconCls: 'add',
            handler: Ext.Function.bind(this.Owner.OnShowWindow, this.Owner, ['add'])
        });
        this._btn_del = Ext.create('Ext.Button',{
            text: 'Eliminar',
            id: 'del_HClinica_btn_id',
            tooltip : 'Elimina el HClinica de Protecci&oacute;n seleccionado',
            iconCls: 'del_item',
            disabled: true,
        ...
        this._btn_mod = Ext.create('Ext.Button', {
            text: 'Modificar',
            id: 'mod_HClinica_btn_id',
            tooltip : 'Modifica el HClinica de Protecci&oacute;n seleccionado',
            iconCls: 'modify',
            disabled: true,
...
App.RegisterFunction('HClinicaGestionar', new HClinicaGestionar());
HClinica.prototype.OnShowWindow = function(_paccion){
    if(_paccion == 'add')
    {
        var unidad=null;
        var AreaCombo= null;        
        this.__data_store_unidad = App.BuildJsonStore('HClinica.HClinica.CargarDatosUnidad',
        {
            fields: [
            {
                type: 'string',
        ...
        var __data_store_Cargo = App.BuildJsonStore('HClinica.HClinica.CargarDatosCargo',
        {
            fields: [
            {
                type: 'string',
        ...
        var __data_store_Area = App.BuildJsonStore('HClinica.HClinica.CargarDatosArea',
        {
            fields: [
            {
                type: 'string',
        ...
        var _gst_win = new Ext.Window({
            title:'Adicionar un HClinica de Protecci&oacute;n',
            id: '_gst_Add_win_id',
...
HClinica.prototype.OnAssoc = function(_paccion){
    if(_paccion == 'asc')
    {
        var unidad=null;
        var AreaCombo= null;        
        ...
        var __data_store_Trab = App.BuildJsonStore('HClinica.HClinica.CargarContratoExistente',
        {
            fields: [
            {
                type: 'string',
        ...
        var __data_store_Equip = App.BuildJsonStore('HClinica.HClinica.CargarDatosEquipo',
        {
            fields: [             
            {
                type: 'string',
        ...
        var __data_store_Equip2 = App.BuildJsonStore('HClinica.HClinica.CargarDatosEquipoExistentes',
        {
            fields: [
            {
                type: 'string',
...
var _gst_win = new Ext.Window({
    title:'Asignaci&oacute;n de HClinica de Protecci&oacute;n',
    id: '_gst_Add_win_id',
    name: '_gst_Add_win_id',
    height:'75%',
    width: '50%',
...
HClinica.prototype.OnShowWindow2 = function(_paccion){
    if(_paccion == 'upd')
    {
        var unidad=null;
        var AreaCombo= null;  
        var selected = Ext.getCmp('HClinica_grid_id').getSelectionModel().getLastSelected();
        this.__data_store_unidad = App.BuildJsonStore('HClinica.HClinica.CargarDatosUnidad',
        {
            fields: [
            {
        ...
        var __data_store_Cargo = App.BuildJsonStore('HClinica.HClinica.CargarDatosCargoModificar',
        {
            fields: [
            {
                type: 'string',
        ...
        var __data_store_AreaE = App.BuildJsonStore('HClinica.HClinica.CargarDatosCargoExistente',
        {
            fields: [
            {
                type: 'string',
...
__data_store_Cargo.filter('id_agencia','--');
    ...
    var _gst_win = new Ext.Window({
        title:'Modificar un HClinica de Protecci&oacute;n',
        id: '_gst_Add_win_id',
        name: '_gst_Add_win_id',
        height:'75%',
        width: '50%',
...
HClinica.prototype.Add = function(_paccion){
    if (Ext.getCmp('panel').getForm().isValid())
    {
        ...
        else
        {
            ...
            var fnCallBack = function() {
                ...
                var _result = App.PerformSyncServerRequest('HClinica.HClinica.Add', values);
                App.HideMsgBox();
                ...
                if(_result)
                {
                    ...
                    App.InfoMessage('Información', 'HClinica de Protecci&oacute;n adicionado satisfactoriamente');
                }
            }
...
HClinica.prototype.Assoc = function(_paccion){
    if (Ext.getCmp('panel').getForm().isValid())
    {
        var _me = this,
        _array = new Array(),
        ...
        else
        {
            ...
            var fnCallBack = function() {
                ...
                var _result = App.PerformSyncServerRequest('HClinica.HClinica.AssociarHClinicaAPersonas', values);
                App.HideMsgBox();
...
HClinica.prototype.Modid = function(_paccion,_selectionModel,_selected_rcd){

    if (Ext.getCmp('panelupd').getForm().isValid())
    {
        App.ShowMsgBox(Ext.Msg.wait('Por favor, espere un momento', 'Procesando...'));
        var _result = App.PerformSyncServerRequest('HClinica.HClinica.Modid',this.panelupd.getForm().getValues());
        App.HideMsgBox();
        ...
        if(_result)
        {
            ...
            Ext.getCmp('HClinica_grid_id').store.load();
            App.InfoMessage('Información', 'HClinica de Protecci&oacute;n modificado satisfactoriamente');
        }
    }
}
HClinica.prototype.deltect=function(_paccion){
    var me = this;
    var fnCallBack = function() {
        var _selected_rcd = Ext.getCmp('HClinica_grid_id').getSelectionModel().getLastSelected();
        var id = _selected_rcd.data.id;
        App.ShowMsgBox(Ext.Msg.wait('Por favor, espere un momento', 'Procesando...'));
        _result = App.PerformSyncServerRequest('HClinica.HClinica.Eliminar', {
            id: id
        });
        App.HideMsgBox();
        ...
        {
            Ext.getCmp('HClinica_grid_id').store.load();
            App.InfoMessage('Información', 'HClinica de Protecci&oacute;n eliminado correctamente');
        }
    }

    App.ConfirmMessage(fnCallBack, '¿Está seguro que desea eliminar este HClinica de Protecci&oacute;n?');

}
HClinica.prototype.OnReal = function(_paccion){
    if(_paccion == 'real')
    {
        var unidad=null;
        var AreaCombo= null;
        ...
        var __data_store_Equip2 = App.BuildJsonStore('HClinica.HClinica.CargarDatosEquipoRelacionados',
            {
                fields: [
                    {type: 'string',name: 'id_agencia'},
                    {type: 'string',name: 'id_area'},
                    ...
                    {type: 'string',name: 'fecha_asignacion', header:'Fecha asignaci&oacute;n'},
        ...
        var _grid2 = new Ext.grid.GridPanel(
            {
                ...
                columns : [
                    ...
                    {header: 'Fecha de Asignaci&oacute;n',dataIndex: 'fecha_asignacion',flex: 30}
                ],
                listeners:{
                    itemdblclick: function(This,record){
                        __data_store_Equip.add(record.data);
        ...
        var _gst_win = new Ext.Window({
            ...
            buttons: [{
                ...
                iconCls:'',
                handler:function(){
                    App.PrintModelGruping(__data_store_Equip2,'titulo');
                },
