...
(function() {
  ...
  jqapi.Header = (function() {
    ...
    Header.prototype.getSignatures = function(entry) {
      var arg, argsArr, ent, joinArr, retArr, sig, sigArr, _i, _j, _k, _len, _len1, _len2, _ref;
      retArr = [];
      _ref = entry.entries;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ent = _ref[_i];
...
(function() {
  ...
  jqapi.Entry = (function() {
    ...
    Entry.prototype.getSignatureTitle = function(title, signature) {
      var arg, argsArr, joinArr, methodName, sigTitle, _i, _len;
      sigTitle = title;
      if (title.substr(title.length - 2) === '()') {
    ...
    Entry.prototype.insertArguments = function(signature, el) {
      var arg, args, argsEl, _i, _len, _results;
      argsEl = $('.arguments', el);
      ...
      for (_i = 0, _len = args.length; _i < _len; _i++) {
        arg = args[_i];
        if (arg && arg.name) {
          _results.push(argsEl.append($(templates.argumentsItem(arg))));
        } else {
