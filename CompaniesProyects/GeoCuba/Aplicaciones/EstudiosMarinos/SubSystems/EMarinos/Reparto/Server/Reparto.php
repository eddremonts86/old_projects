...
class Reparto extends Module {
    ...
    public function ValidateEliminar(&$params) {
        ...
        $count = $datos->Contains(array('lugarid' => "'$id'"));
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "El lugar a eliminar está siendo usado por Trabajador.");
            return false;
        }
        return true;
    }
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.lugar");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Nombre del lugar incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.lugar');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El lugar '$nombre' ya existe.");
            return false;
        }return true;
       }
