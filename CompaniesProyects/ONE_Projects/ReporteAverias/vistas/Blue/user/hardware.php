		...
		<script type="text/javascript" src="../../../Jss/Personalizadas/user/hardware.js"></script>

<?php
 
if($_GET['termino']==Hardwar){	
	...
	/*Guardar los datos en la BD*/
	 $a=$hard->RealizarHard($equipo,$comentario,$provincias,$municipio,$departamento,$fecha,$codigo,$estado,$Nombre,$email,$Localidad,$tipoRPA);	
	/*            Fin              */	
