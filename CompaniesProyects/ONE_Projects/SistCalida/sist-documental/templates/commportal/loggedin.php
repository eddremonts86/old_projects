<?php 
// Create an alert and redirect user if not logged in
global $option, $extmode, $task;
...
?>
			<script type="text/javascript">	
			 alert('Please register and login via the homepage to view the website.');
			window.document.location.href='index.php';
			</script>
<?php } }?>
<!-- If logged in check start -->
...
<!-- BreadC / Login -->
<div id="s5_breadlogin">
	<?php if ($s5_breadcrumbs  == "show") { ?>
	<div id="s5_breadcrumbs"><jdoc:include type="modules" name="breadcrumbs" style="rawl" /></div>
	<?php } ?>
	...
	<?php } ?>
		...
		<?php if($this->countModules('debug')) { ?>
		<div class="s5_bleft"></div>
		<div class="s5_bmiddle" onclick="s5boxtwo('popup_outer3');show_popup3();"><?php  if ( $my->id ) { echo $s5_boxtwobutin ;} else { echo $s5_boxtwobut ; }?></div>
		<div class="s5_bright"></div>
		<?php } ?>
