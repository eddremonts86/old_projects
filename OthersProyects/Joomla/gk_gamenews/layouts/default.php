...
<body<?php echo $tpl_page_suffix; ?><?php if($this->browser->get("tablet") == true) echo ' data-tablet="true"'; ?><?php if($this->browser->get("mobile") == true) echo ' data-mobile="true"'; ?><?php $this->layout->generateLayoutWidths(); ?> data-bg="<?php echo $this->API->get('template_bg', '1'); ?>">	
	...
	<div id="gkPage">        
	    ...
	    <section id="gkPageTop" >                    	
            ...
            <div class=" visible-lg banner_top">
                <?php if($this->API->modules('vta_custom1') || $this->API->modules('vta_custom2') || $this->API->modules('vta_custom3') ) : ?>
                    <div class="">
                        <div class="" style="float:right;width: 35% !important;height: 113px;padding: 2px;margin:4px;">
                        ...
                        <div class="" style="float:right;width: 40% !important;height: 113px;padding: 2px;margin:4px;">
    	...
    	<div>
           ...
           <div class="date">
			<div id="fecha"> <div class="date">
             <?php
                    $m = date("m");
                    $fechaEs = array('Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre');
                    $fechaIN = array('January','February','March','April','May','June','July','August','September', ' October ', ' November ','December');
                    $desEs = "Bienvenido, hoy es: ".date('d');
                    $desIn = "Welcome, today it's: ";
                    $if = (int)$m;
                    $o = $if -1;
                    $anno=date('Y');
                    if($leng=='es-es'){
                        echo $desEs.' / '.$fechaEs[$o].' / '.$anno;
                    }else{
                        echo $desIn.$fechaIN[$o].' '.date('d').' '.$anno;
                    }
              ?>
