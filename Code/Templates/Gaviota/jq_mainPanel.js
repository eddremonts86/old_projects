...
function model() {
    var html = '<div id="map_OSMCache_id" style="width: 100%; height: 300px; float: left;"></div>';
     var info=   '<div class="panel panel-success" style="width: 100%; height: 100%;margin-left: 0px; float: none;">'+
            '<div class="panel-heading">Tiempo estimado en auto</div>'+
                '<div class="panel-body" style="margin: 0px !important;">'+
                    ...
                    '<thead>'+
                    '<tr>'+
                    '<th style="width: 60%">OSMCache<i class="fa fa-sort"></i></th>'+
    ...
    var map = new OpenLayers.Map('map_OSMCache_id', {
...
function ShowInfo(){
    ...
    $('#OSMCache_name_id').text(selected_feature_data.data.name);
    $('#myModal').modal('show');
}
var  map='';
