...
//            ||!isset($params['combo_talla_zapato_value_id']))
    ...
    public function Add(&$params)
    {
        //print_r($params);die;
        $valores = array();
        $valores['fecha_inicio'] = "'".$params['fecha_inicio']."'";
        $valores['tiempo'] = "'".$params['meses']."'";
        $name = $params['nombre_id'];
        $valores['nombre'] = "'".$params['nombre_id']."'";
        $valores['sexoid'] = "'".$params['combo_sexo_id']."'";
        $valores['estado_civilid'] = "'".$params['combo_estadicivil_value_id']."'";
        $valores['color_pielid'] = "'".$params['combo_cpiel_value_id']."'";

        if($params['combo_reparto_value_id'] != '')
           $valores['repartoid'] = "'".$params['combo_reparto_value_id']."'";
        if($params['combo_lugarproced_value_id'] != '')
            $valores['lugar_procedenciaid'] = "'".$params['combo_lugarproced_value_id']."'";
        $valores['nivel_culturalid'] = "'".$params['combo_ncultural_value_id']."'";
        $valores['ubicacion_excepcionalid'] = "'".$params['combo_ubicacion_value_id']."'";
        $valores['integracionid'] = "'".$params['combo_integracion_value_id']."'";
        $valores['registro_militarid']  = "'".$params['combo_registro_value_id']."'";
        $valores['talla_camisa_blusa']  = "'".$params['combo_talla_camisa_value_id']."'";
        $valores['talla_pantalon_saya'] = "'".$params['combo_talla_pantalon_value_id']."'";
        $valores['talla_zapato'] = "'".$params['combo_talla_zapato_value_id']."'";
        $valores['direccion'] = "'".$params['Direccion']."'";

        if ($params['Sancionado'] == 1) {
            $valores['sancionado'] = "'t'";
        } else {
            $valores['sancionado'] = "'f'";
        }

        $valores['peso'] = "'".$params['Peso']."'";
        $valores['telefono'] = "'".$params['Telefono']."'";
        $valores['codigo_nomina'] = "'".$params['cod_nomina']."'";
        $valores['no_identidad'] = "'".$params['identidad']."'";
        $valores['apellido_1'] = "'".$params['SegundoApellido']."'";
        $valores['apellido_2'] = "'".$params['PrimerApellido']."'";
        $sapellido = $params['SegundoApellido'];
        $papellido = $params['PrimerApellido'];
        $valores['nombre_completo'] = "'".$name." ".$papellido." ".$sapellido."'";
        $valores['estatura'] = "'".$params['estatura']."'";
        $valores['fecha_nacimiento'] = "'".$params['fecha_nacimiento']."'";
        $valores['nombre_madre'] = "'".$params['madre']."'";
        $valores['nombre_padre'] = "'".$params['padre']."'";
        $valores['codigo'] = "'".$params['codigo_id']."'";
        $valores['especialidad_id'] = "'".$params['especialidad']."'";

        $defensa = $params['defensa'];

        if(isset($_FILES['fileup']['tmp_name']))
            $valores['foto'] = "'".base64_encode(file_get_contents($_FILES['fileup']['tmp_name']))."'";

        $datos = $this->_dbase->GetTable("plantilla.trabajador");
        $data = $datos->InsertValues($valores);

        $gege=$datos->GetAll("nombre_completo = ".$valores['nombre_completo']."");
        $idtrba=$gege[0]['id'];
