function Equipos() {
    this.Init = function () {
        ...
        {
            text: 'Equipos de Protecci&oacute;n',
            id: 'Equipos_menu_id',
            iconCls: 'nomencladores',
            handler: Ext.Function.bind(this.ShowMainWindow, this)
        };
        App.InsertMenuItem('Seguridad', _menu_item_config);

    }
    // ========================================================================//
    this.BuildMainPanel = function (filterObj) {
        this.__data_store_lcargoas = App.BuildJsonStore('Equipos.Equipos.CargarDatos',{
                fields: [
                    {name: 'id'},
                    {name: 'nombre_equipo'},
                    {name: 'cargo'},
                ...
                Ext.create('Ext.window.Window', {
                    ...
                    html:
                        '<ul class="nav nav-list">' +
                            '<li>El m&oacute;dulo <span class="label label-info">" Gestionar Equipos de Protecci&oacute;n"</span>' +
                            ...
                            '<img src="SubSystems/SST/Config/Client/app_images/equiprot.png">' +
                            'El listado geral' +
                            '<br> Existen campos que son obligatorios para el completamiento funcional de este m&oacute;dulo<br>' +
                    ...
                    selectionchange: {
                        fn: function (View, selections, options) {
                            if (selections.length == 0) {
                                this.Disable('EquiposGestionar');
                            }
                            else {
                                this.Enable('EquiposGestionar');
                            }
        ...
        var _panel = new Ext.Panel(
            {
                title: 'Gestionar Equipos de Protecci&oacute;n',
                border: true,
                frame: true,
                id:'panel_general',
                name:'panel_general',
...
App.RegisterModule('Equipos', new Equipos());