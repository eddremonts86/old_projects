...
function Registro_Eventos(){
    ...
    this.BuildMainPanel = function(filterObj)
    {
       ...
       this.__data_store = App.BuildJsonStore('Registro_Eventos.Registro_Eventos.CargarDatos',{
        ...
        this.unidad = App.BuildJsonStore('Registro_Eventos.Registro_Eventos.Cargarunidad',{
            fields: [
                {name: 'id'},
                {name: 'nombre'}
       ...
       this._grid_historial = App.BuildJsonStore('Registro_Eventos.Registro_Eventos.historial',{
        ...
        var _grid = new Ext.grid.Panel({
            ...
            columns: [
                ...
                {header: 'Unidad Estructural',menuDisabled: true,sortable : false,dataIndex: 'Unidad',flex: 1,
                    editor: new Ext.form.field.ComboBox({
                        triggerAction: 'all',
                        queryMode:'local',
                        store: this.unidad,
                        ...
                        handler:function( This, eOpts){
                            ...
                            else
                            {
                                ...
                                var fnCallBack = function()   {
                                    ...
                                    var FFt = Ext.Date.format(fi,'time');
                                    var FFF = Ext.Date.format(ft,'time');
                                    if(FFt < FFF){
                                    if(form.isValid()){
                                        ...
                                        App.InfoMessage('Información', 'La Fecha de fin es menor que la fecha inicio.Por favor reviselo');
                                        App.HideMsgBox();
                                    }
                                }
        ...
        var _grid_historial = new Ext.grid.Panel({
            ...
            columns: [
                {header: 'Título',menuDisabled: true,sortable : false,flex: 1,dataIndex: 'titulo'}
            ],
            viewConfig: {forceFit: true},
            bbar:{
        ...
        var _panel = new Ext.Panel({
            title: 'Registro Eventos de superación',
            border: true,
            frame: true,
            layout: 'border',
