                            ...
                            Ext.create('Ext.window.Window', {
                                ...
                                html:
                                    '<ul class="nav nav-list">' +
                                        '<li>El modulo <span class="label label-info">" Control de Certificados"</span>' +
                                        ' le permite gestionar los Certificados de los trabajadores, es decir todos los Títulos, Diplomados, etc que obtenga un trabajador.<br>' +
                                        '</li>' +
                                        '</ul>'
