...
//======================================================================================================================
        var panel_tree = Ext.create('Ext.form.Panel', {
            ...
            html: '<div class="accordion" id="accordion2">' +
                ...
                '       <div class="accordion-inner" onclick="TrabajadoresJublacion()"><a> ' + 'Trabajadores que se Jubilan </a></div>' +
                '</div>' + '</div>' +
                '      <div class="accordion-group">' + '<div class="accordion-heading">' +
...
function TrabajadoresJublacion() {
    var grid = Ext.getCmp('LCIndeterminado_grid_id');
    var panel = Ext.getCmp('panelNombre');
    Ext.suspendLayouts();
    this.__data_store = App.BuildJsonStore('Resumenes.Resumenes.jubilacion', {
        fields: [
            {name: 'trabj'},
            {name: 'edad'},
            {name: 'foto'},
    ...
    this.__data_store.load({params: {start: 0, limit: 25}});
    panel.setTitle('Todos los Reportes - <span class="label label-info">Trabajadores a jubilar en este asño</span>');
    grid.reconfigure(this.__data_store, [
        Ext.create('Ext.grid.RowNumberer'),
        {   header: 'Foto',
            locked: true,
