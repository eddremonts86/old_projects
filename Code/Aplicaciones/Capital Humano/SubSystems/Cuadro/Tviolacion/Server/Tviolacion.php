...
class Tviolacion extends Module {
    ...
    public function ValidateEliminar(&$params) {
        ...
        $count = $datos->Contains(array('sexoid' => "'$id'"));
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "El Tipo de violación a eliminar esta siendo usado por Trabajador.");
            return false;
        }
        return true;
    }
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("cuadro.Tviolacion");
    ...
    public function ValidateAdd(&$params){
       // print_r($params);
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Tipo de violación incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('cuadro.Tviolacion');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El Tipo de violación '$nombre' ya existe.");
            return false;
        }return true;
       }
