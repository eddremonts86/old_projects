function ViolacionesGestionar()
{
    ...
    this.Render = function(Panel){
        this._btn_add = Ext.create('Ext.Button',{
            ...
            tooltip : 'Adiciona una  nueva Violación',
            iconCls: 'list_add16',
        ...
        this._btn_del = Ext.create('Ext.Button',{
            ...
            tooltip : 'Elimina la Violación seleccionada',
        ...
        this._btn_mod_res= Ext.create('Ext.Button', {
            ...
            tooltip : 'Historial de Violaciones',
            iconCls: 'apply16',
            disabled: false,
...
Violaciones.prototype.Add = function(_paccion){
    ...
    if (Ext.getCmp('panel').getForm().isValid())
    {
        ...
        if(_result)
        {
            ...
            this.__data_store.load();
            App.InfoMessage('Información', 'Violación adicionada satisfactoriamente');
        }
    }
}
Violaciones.prototype.Modid = function(_paccion,_selectionModel,_selected_rcd){
    ...
    if (Ext.getCmp('panelupd').getForm().isValid())
    {
        ...
        if(_result)
        {
            ...
            this.__data_store.load();
            App.InfoMessage('Información', 'Violación modificada satisfactoriamente');
        }
    }
 }
Violaciones.prototype.deltectcp=function(_paccion){
    ...
    var fnCallBack = function() {
        ...
        if(_result)
        {
            ...
            App.InfoMessage('Información', 'Violación eliminada correctamente');
        }
    }

    App.ConfirmMessage(fnCallBack, '¿Está seguro que desea eliminar esta violación?');
