        ...
        var _grid = new Ext.grid.Panel({
          ...
          /*  height: App.GetDesktopHeigth() - 35,
            ...
            columns: [
                ...
                {header: '% Cumplimiento', dataIndex: 'cumpl', flex: 4, align: 'center', renderer: function(value, metaData, record)
                {
                ...
                {header: 'Observaciones', dataIndex: 'obs', flex: 4, align: 'center', renderer: function(value, metaData, record)
                {
