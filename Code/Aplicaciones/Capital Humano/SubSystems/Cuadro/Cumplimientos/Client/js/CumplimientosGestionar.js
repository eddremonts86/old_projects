function CumplimientosGestionar()
{
    ...
    this.Render = function(Panel){
        this._btn_add = Ext.create('Ext.Button',{
            ...
            tooltip : 'Guardar datos de  Cumplimiento',
            iconCls: 'list_add16',
        ...
        this._btn_mod = Ext.create('Ext.Button', {
            ...
            tooltip : 'Historial de  Cumplimientos',
            iconCls: 'apply16',
            disabled: false,
            ...
            else
            {
               ...
               var fnCallBack_after = function()   {
                           ...
                           var _result = App.PerformSyncServerRequest('Cumplimientos.Cumplimientos.Add',{data: Ext.encode(_array),formada:formada});
                            ...
                            if(_result)
                            {
                                App.InfoMessage('Información', 'Cumplimento guardado satisfactoriamente');
                            }
                            else
                            {
    ...
    if(_paccion == 'upd')
     {
         ...
         this._grid = new Ext.grid.Panel({
             ...
             columns: [
                 ...
                 {header: '% Cumplimiento', dataIndex: 'compli', flex: 4, align: 'center', renderer: function(value, metaData, record){
                 ...
                 {header: 'Observaciones', dataIndex: 'observ', flex: 4, align: 'center',
...
Cumplimientos.prototype.Add = function(_paccion){
    ...
    if (Ext.getCmp('panel').getForm().isValid())
    {
        ...
        if(_result)
        {
            ...
            this.__data_store.load();
            App.InfoMessage('Información', 'Cumplimientos guardado satisfactoriamente');
        }
    }
}
