...
class Reparto extends Module {
    ...
    public function CargarDatos(&$params) {
        ...
        $_limit = $params['limit'];
        $_table = $this->_dbase->GetTable('nomencladores.reparto');
    ...
    public function ValidateEliminar(&$params) {
        ...
        $count = $datos->Contains(array('repartoid' => "'$id'"));
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "El Reparto a eliminar está siendo usado por Trabajador.");
            return false;
        }
        return true;
    }
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Nombre del Reparto incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.reparto');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El Reparto '$nombre' ya existe.");
            return false;
        }return true;
       }
    public function Add(&$params){
       ...
       $datos=$this->_dbase->GetTable("nomencladores.reparto");
       return $data=$datos->InsertValues(array('nombre' => "'$name'",'municipioid' => "'$datos_UBT_id'"));
    ...
    public function Modid(&$params){
        ...
        $datos_UBT_id=$params['datos_UBT_id'];
        $datos=$this->_dbase->GetTable("nomencladores.reparto");
        $datos->Update(array('nombre' => "'$name'",'municipioid' => "'$datos_UBT_id'"),"id = '$ids'");
        return true;
    }
