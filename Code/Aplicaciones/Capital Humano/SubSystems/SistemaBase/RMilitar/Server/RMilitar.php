...
class RMilitar extends Module {
    ...
    public function CargarDatos(&$params) {
        ...
        $_limit = $params['limit'];
        $_table = $this->_dbase->GetTable('nomencladores.registro_militar');
    ...
    public function ValidateEliminar(&$params) {
        ...
        $count = $datos->Contains(array('registro_militarid' => "'$id'"));
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "El Registro Militar a eliminar está siendo usado por Trabajador.");
            return false;
        }
        return true;
    }
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.registro_militar");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Nombre del Registro Militar incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.registro_militar');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El Registro Militar '$nombre' ya existe.");
            return false;
        }return true;
       }
