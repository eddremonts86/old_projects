...
class Gmilitar extends Module {
    ...
    public function ValidateEliminar(&$params) {
        ...
        $count = $datos->Contains(array('grado_militarid' => "'$id'"));
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "El Grado Militar a eliminar está siendo usado por Oficial.");
            return false;
        }
        return true;
    }
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.grado_militar");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Nombre del Grado Militar incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.grado_militar');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El Grado Militar '$nombre' ya existe.");
            return false;
        }return true;
       }
