...
class mbaja extends Module {
    ...
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.mbajas");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Motivo de Baja incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.mbajas');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El Motivo de Baja '$nombre' ya existe.");
            return false;
        }return true;
       }
