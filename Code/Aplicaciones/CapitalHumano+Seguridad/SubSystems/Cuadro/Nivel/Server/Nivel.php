...
class Nivel extends Module {
    ...
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("cuadro.nivel");
    ...
    public function ValidateAdd(&$params){
       // print_r($params);
        ...
        $actividades = $this->_dbase->GetTable('cuadro.nivel');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El nivel '$nombre' ya existe.");
            return false;
        }return true;
       }
