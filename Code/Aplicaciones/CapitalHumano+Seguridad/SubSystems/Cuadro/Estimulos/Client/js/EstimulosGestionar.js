function EstimulosGestionar()
{
    ...
    this.Render = function(Panel){
        this._btn_add = Ext.create('Ext.Button',{
            ...
            tooltip : 'Adiciona un  nuevo Estimulos',
            iconCls: 'list_add16',
        ...
        this._btn_del = Ext.create('Ext.Button',{
            ...
            tooltip : 'Elimina el Estimulos seleccionado',
        ...
        this._btn_mod = Ext.create('Ext.Button', {
            ...
            tooltip : 'Modifica el Estimulos seleccionado',
            iconCls: 'apply16',
            disabled: true,
...
Estimulos.prototype.Add = function(_paccion){
    ...
    if (Ext.getCmp('panel').getForm().isValid())
    {
        ...
        if(_result)
        {
            ...
            this.__data_store.load();
            App.InfoMessage('Información', 'Estimulos adicionado satisfactoriamente');
        }
    }
}
Estimulos.prototype.Modid = function(_paccion,_selectionModel,_selected_rcd){
    ...
    if (Ext.getCmp('panelupd').getForm().isValid())
    {
        ...
        if(_result)
        {
            ...
            this.__data_store.load();
            App.InfoMessage('Información', 'Estimulos modificado satisfactoriamente');
        }
    }
 }
Estimulos.prototype.deltectcp=function(_paccion){
    ...
    var fnCallBack = function() {
        ...
        if(_result)
        {
            ...
            App.InfoMessage('Información', 'Estimulos eliminado correctamente');
        }
    }

    App.ConfirmMessage(fnCallBack, '¿Está seguro que desea eliminar este Estimulos?');
