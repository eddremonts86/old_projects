...
class eventos extends Module {
    ...
    public function ValidateEliminar(&$params) {
        ...
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "El eventos a eliminar esta siendo usado por Contrato.");
            return false;
        }
        return true;
    }
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.eventos");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Nombre del eventos incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.eventos');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "El eventos '$nombre' ya existe.");
            return false;
        }return true;
       }
