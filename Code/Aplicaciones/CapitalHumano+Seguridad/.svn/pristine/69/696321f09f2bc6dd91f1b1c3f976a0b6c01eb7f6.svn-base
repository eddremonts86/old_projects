 ...
 *	interface of the application. This class contains an
            ...
            this.__menu_bar = new Ext.Toolbar(
                {
                    ...
                    items: [
                        {
                            xtype: 'label',
                            html: ' <a class="brand" rel="popover" data-placement="bottom" onclick="$(\'.subsistem\').popover(\'toggle\')" title="Subsistema activo" data-content="Los subsistemas son diviciones logicas de la aplicacion compusteas de mudulos que satisfacen sus nececidads"><h4 class="subsistem">'+subsystem+'</h4></a>'
                        },'-'],
                    cls:'btn-bar'
                });
            ...
            this.__interface = new Ext.Viewport(
                {
                    ...
                    items: [
                        {
                            xtype: 'panel',
                            height: 34 + InterfaceConf.banner_heigth,
                            border: false,
                            frame: false,
                            region: 'north',
                            ...
                            items: [
                                {
                                    ...
                                    html: '<table cellpading=0 cellspacing=0 width="100%" height="' + InterfaceConf.banner_heigth + '" border=0 >' +
                                        '<tr>' +
                                        '<td width=' + InterfaceConf.left_image_width + '><img src="SubSystems/' + subsystem + '/Config/Client/' + InterfaceConf.left_image + '"/><td>' +
                                        '<td width="100%" height="' + InterfaceConf.banner_heigth + '"/><td>' +
                                        '<td width=' + InterfaceConf.rigth_image_width + '><img src="SubSystems/' + subsystem + '/Config/Client/' + InterfaceConf.rigth_image + '"/><td>' +
                                        '</tr>' +
                                        '</table>'
                                }
                            ]
...
//                                    App.__current_module.__data
                            ...
                            html: '<div align="center" style="background-color:' + InterfaceConf.desktop_color + ';height:100%"><div><img src="Subsystems/' + subsystem + '/Config/Client/' + InterfaceConf.desktop_image + '" width="' + InterfaceConf.desktop_image_width + '" height="' + InterfaceConf.desktop_image_height + '" /></div></div>'
                        }
                    ],
                    listeners: {
                        resize: {
