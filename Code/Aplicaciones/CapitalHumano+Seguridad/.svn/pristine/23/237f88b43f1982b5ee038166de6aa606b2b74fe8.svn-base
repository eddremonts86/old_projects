function PreparacionGestionar()
{
    ...
    this.Render = function(Panel){
        this._btn_add = Ext.create('Ext.Button',{
            ...
            tooltip : 'Adiciona un  nuevo Preparacion',
            iconCls: 'list_add16',
        ...
        this._btn_del = Ext.create('Ext.Button',{
            ...
            tooltip : 'Elimina el Preparacion seleccionado',
        ...
        this._btn_mod = Ext.create('Ext.Button', {
            ...
            tooltip : 'Modifica el Preparacion seleccionado',
            iconCls: 'apply16',
            disabled: true,
...
Preparacion.prototype.Add = function(_paccion){
    ...
    if (Ext.getCmp('panel').getForm().isValid())
    {
        ...
        if(_result)
        {
            ...
            this.__data_store.load();
            App.InfoMessage('Información', 'Preparacion adicionado satisfactoriamente');
        }
    }
}
Preparacion.prototype.Modid = function(_paccion,_selectionModel,_selected_rcd){
    ...
    if (Ext.getCmp('panelupd').getForm().isValid())
    {
        ...
        if(_result)
        {
            ...
            this.__data_store.load();
            App.InfoMessage('Información', 'Preparacion modificado satisfactoriamente');
        }
    }
 }
Preparacion.prototype.deltectcp=function(_paccion){
    ...
    App.ConfirmMessage(fnCallBack, '¿Está seguro que desea eliminar este Preparacion?');
