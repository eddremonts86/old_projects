        ...
        tbar.add({
            ...
            listeners: {
                change:function(){
                    ...
                    Ext.getCmp('Contrato_grid_id').store.filter("nombre_completo", Ext.getCmp('searchField').getValue());
                    Ext.getCmp('Contrato_grid_id').store.filter("tipo_contrato", Ext.getCmp('searchField1').getValue());
                },scope:this
            }
        });
        tbar.add('-');
