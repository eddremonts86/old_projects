function Cap_TrabajadorGestionar() {
    ...
    this.Render = function (Panel) {
        ...
        this._btn_mod = Ext.create('Ext.Button', {
            ...
            tooltip: 'Editar la  Capapacitaci&oacute;n del Trabajador seleccionado',
            iconCls: 'modify',
            disabled: true,
...
Cap_Trabajador.prototype.winupdCap_Trabajador = function (_paccion) {
    ...
    var cientifica= Ext.create('Ext.form.ComboBox', {
        fieldLabel: 'Categoria Cientifica',
    ...
    if (_paccion == 'upd') {
        {
            this.panelupdCap_Trabajador = Ext.create('Ext.form.Panel', {
                ...
                items: [
                    ...
                    xtype:'fieldset',
                    columnWidth: 0.4,
                    title: 'Formaci&oacute;n T&eacute;cnico Profecional ',
                    collapsible: true,
                    id:'Formacion',
                    name:'Formacion',
                    defaults: {anchor: '100%'},
                    ...
                    items :[
                        ...
                        {
                            xtype: 'radiogroup',
                            fieldLabel: 'Pais de graduaci&oacute;n',
                            labelWidth:130,
                            columns: 3,
                            items: [
                            ...
                            Ext.create('Ext.window.Window', {
                                ...
                                html:
                                    '<ul class="nav nav-list">' +
                                        ...
                                        ' le permite gestionar toda la información referente a la formación profecional del trabajador  </li>' +
                                         '</li>' +
                                        '</ul>'
