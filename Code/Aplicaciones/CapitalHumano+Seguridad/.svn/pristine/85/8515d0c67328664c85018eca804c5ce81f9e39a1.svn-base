...
class Intragracion extends Module {
    ...
    public function CargarDatos(&$params) {
        ...
        $_limit = $params['limit'];
        $_table = $this->_dbase->GetTable('nomencladores.integracion');
    ...
    public function ValidateEliminar(&$params) {
        ...
        $count = $datos->Contains(array('integracionid' => "'$id'"));
        if ($count > 0) {
            $this->RegisterError('Operación no válida', "La Integración a eliminar está siendo usado por Trabajador.");
            return false;
        }
        return true;
    }
    public function Eliminar(&$params) {
        ...
        $result=null;
            if ($id) {
                $datos=$this->_dbase->GetTable("nomencladores.integracion");
    ...
    public function ValidateAdd(&$params){
        ...
        if (!$_valid) {
            $this->RegisterError('Parámetro incorrecto', "Nombre de la Integración incorrecto.");
            return false;
        }
        ...
        $actividades = $this->_dbase->GetTable('nomencladores.integracion');
        ...
        elseif ($count > 0) {
            $this->RegisterError('Operación no válida', "La Integración '$nombre' ya existe.");
            return false;
        }return true;
       }
