...
class FunctionsManager extends Module
{
     ...
     public function ValidateSetRol(&$params)
     {
          ...
          if(is_null($_user_id))
          {
               $this->RegisterError('Operaci�n no v�lida', "El usuario '$_user' no existe.");
               return false;
          }
          ...
          {
               $this->RegisterError('Operaci�n no v�lida', "El sistema '$_system' no existe.");
               return false;
          }
          ...
          if($_count == 0)
          {
               $this->RegisterError('Operaci�n no v�lida', "El usuario '$_user' no tiene acceso al sistema '$_system'.");
               return false;
          }
          ...
          {
               $this->RegisterError('Par�metro no v�lido', "Los permisos seleccionados no son v�lidos.");
               return false;
          }
