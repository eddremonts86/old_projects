...
<head>
    ...
    <link id="default" rel="stylesheet" type="text/css" href="Framework/Client/frk2.0/dist/css/bootstrap.css">
<!--    <link id="default" rel="stylesheet" type="text/css" href="Framework/Client/frk2.0/dist/css/bootstrap.min.css">-->
    <link id="default" rel="stylesheet" type="text/css" href="Framework/Client/frk2.0/dist/css/bootstrap-theme.css">
    <link id="default" rel="stylesheet" type="text/css" href="Framework/Client/oxigen/16x16/icons16x16.css">
   <link rel="stylesheet" href="Framework/Client/jqwidgets/jqwidgets/styles/jqx.base.css" type="text/css" />
    <link id="default" rel="stylesheet" type="text/css" href="Framework/Client/jqwidgets/jqwidgets/styles/jqx.metro.css">
    <link id="default" rel="stylesheet" type="text/css" href="Framework/Client/jqwidgets/jqwidgets/styles/jqx.darkblue.css">
    <link id="default" rel="stylesheet" type="text/css" href="Framework/Client/jqwidgets/jqwidgets/styles/jqx.metrodark.css">
    <link rel="stylesheet" href="Framework/Client/frk2.0/dist/font-awesome/css/font-awesome.min.css">

    <script type="text/javascript" src="Framework/Client/jqwidgets/scripts/jquery-1.10.2.min.js"></script>
    ...
    <script src="Framework/Client/frk2.0/js/morris/chart-data-morris.js"></script>
    <script src="Framework/Client/frk2.0/js/tablesorter/jquery.tablesorter.js"></script>
    <script src="Framework/Client/frk2.0/js/tablesorter/tables.js"></script>
    <script src="Framework/Client/frk2.0/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <!-- Page-Level Plugin Scripts - Tables -->
    <script src="Framework/Client/frk2.0/js/plugins/dataTables/jquery.dataTables.js"></script>
    <script src="Framework/Client/frk2.0/js/plugins/dataTables/dataTables.bootstrap.js"></script>
   ...
   <!-- <script src="Framework/Client/FrKCss/js/ui/jquery.ui.core.js"></script>
    ...
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxcore.js"></script>
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxdata.js"></script>
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxbuttons.js"></script>
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxscrollbar.js"></script>
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxmenu.js"></script>
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxgrid.js"></script>
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxgrid.grouping.js"></script>
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxgrid.edit.js"></script>
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxgrid.selection.js"></script>
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxgrid.sort.js"></script>
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxgrid.filter.js"></script>
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxdata.js"></script>
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxlistbox.js"></script>
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxgrid.pager.js"></script>
    <script type="text/javascript" src="Framework/Client/jqwidgets/jqwidgets/jqxdropdownlist.js"></script>
...
<script type="text/javascript">document.getElementById('loading_div-msg').innerHTML = 'Cargando m&oacute;dulos...';</script>
<?PHP
